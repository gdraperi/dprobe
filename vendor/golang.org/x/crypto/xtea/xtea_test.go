...
func TestCipherInit(t *testing.T) ***REMOVED***
	c, err := NewCipher(testKey)
	if err != nil ***REMOVED***
		t.Errorf("NewCipher(%d bytes) = %s", len(testKey), err)
		return
	***REMOVED***
	...
	for i := 0; i < len(c.table); i++ ***REMOVED***
		if c.table[i] != testTable[i] ***REMOVED***
...
func TestInvalidKeySize(t *testing.T) ***REMOVED***
	...
	***REMOVED***
	...
	// Test a short key
	key = []byte***REMOVED***0x00, 0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77***REMOVED***
...
func TestEncodeDecode(t *testing.T) ***REMOVED***
	original := []byte***REMOVED***0x01, 0x23, 0x45, 0x67, 0x89, 0xAB, 0xCD, 0xEF***REMOVED***
	input := original
	...
	***REMOVED***
	...
	differs := false
	for i := 0; i < len(input); i++ ***REMOVED***
		if output[i] != input[i] ***REMOVED***
			differs = true
			break
		***REMOVED***
	***REMOVED***
	if differs == false ***REMOVED***
	...
	***REMOVED***
	...
	for i := 0; i < len(input); i++ ***REMOVED***
		if output[i] != original[i] ***REMOVED***
...
var CryptTests = []CryptTest***REMOVED***
	// These were sourced from http://www.freemedialibrary.com/index.php/XTEA_test_vectors
	***REMOVED***
		[]byte***REMOVED***0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f***REMOVED***,
		[]byte***REMOVED***0x41, 0x42, 0x43, 0x44, 0x45, 0x46, 0x47, 0x48***REMOVED***,
		[]byte***REMOVED***0x49, 0x7d, 0xf3, 0xd0, 0x72, 0x61, 0x2c, 0xb5***REMOVED***,
	***REMOVED***,
	***REMOVED***
		[]byte***REMOVED***0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f***REMOVED***,
		[]byte***REMOVED***0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41***REMOVED***,
		[]byte***REMOVED***0xe7, 0x8f, 0x2d, 0x13, 0x74, 0x43, 0x41, 0xd8***REMOVED***,
	***REMOVED***,
	***REMOVED***
		[]byte***REMOVED***0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f***REMOVED***,
		[]byte***REMOVED***0x5a, 0x5b, 0x6e, 0x27, 0x89, 0x48, 0xd7, 0x7f***REMOVED***,
		[]byte***REMOVED***0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41***REMOVED***,
	***REMOVED***,
	***REMOVED***
		[]byte***REMOVED***0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00***REMOVED***,
		[]byte***REMOVED***0x41, 0x42, 0x43, 0x44, 0x45, 0x46, 0x47, 0x48***REMOVED***,
		[]byte***REMOVED***0xa0, 0x39, 0x05, 0x89, 0xf8, 0xb8, 0xef, 0xa5***REMOVED***,
	***REMOVED***,
	***REMOVED***
		[]byte***REMOVED***0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00***REMOVED***,
		[]byte***REMOVED***0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41***REMOVED***,
		[]byte***REMOVED***0xed, 0x23, 0x37, 0x5a, 0x82, 0x1a, 0x8c, 0x2d***REMOVED***,
	***REMOVED***,
	***REMOVED***
		[]byte***REMOVED***0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00***REMOVED***,
		[]byte***REMOVED***0x70, 0xe1, 0x22, 0x5d, 0x6e, 0x4e, 0x76, 0x55***REMOVED***,
		[]byte***REMOVED***0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41***REMOVED***,
	***REMOVED***,
	...
	***REMOVED***
		...
		[]byte***REMOVED***0xDE, 0xE9, 0xD4, 0xD8, 0xF7, 0x13, 0x1E, 0xD9***REMOVED***,
	***REMOVED***,
	***REMOVED***
		[]byte***REMOVED***0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00***REMOVED***,
		[]byte***REMOVED***0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08***REMOVED***,
		[]byte***REMOVED***0x06, 0x5C, 0x1B, 0x89, 0x75, 0xC6, 0xA8, 0x16***REMOVED***,
	***REMOVED***,
	***REMOVED***
		[]byte***REMOVED***0x01, 0x23, 0x45, 0x67, 0x12, 0x34, 0x56, 0x78, 0x23, 0x45, 0x67, 0x89, 0x34, 0x56, 0x78, 0x9A***REMOVED***,
		[]byte***REMOVED***0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00***REMOVED***,
		[]byte***REMOVED***0x1F, 0xF9, 0xA0, 0x26, 0x1A, 0xC6, 0x42, 0x64***REMOVED***,
	***REMOVED***,
	***REMOVED***
		[]byte***REMOVED***0x01, 0x23, 0x45, 0x67, 0x12, 0x34, 0x56, 0x78, 0x23, 0x45, 0x67, 0x89, 0x34, 0x56, 0x78, 0x9A***REMOVED***,
		[]byte***REMOVED***0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08***REMOVED***,
		[]byte***REMOVED***0x8C, 0x67, 0x15, 0x5B, 0x2E, 0xF9, 0x1E, 0xAD***REMOVED***,
	***REMOVED***,
***REMOVED***

// Test encryption
func TestCipherEncrypt(t *testing.T) ***REMOVED***
	for i, tt := range CryptTests ***REMOVED***
		...
		***REMOVED***
		...
		for j := 0; j < len(out); j++ ***REMOVED***
			if out[j] != tt.cipherText[j] ***REMOVED***
...
func TestCipherDecrypt(t *testing.T) ***REMOVED***
	for i, tt := range CryptTests ***REMOVED***
		...
		***REMOVED***
		...
		for j := 0; j < len(out); j++ ***REMOVED***
			if out[j] != tt.plainText[j] ***REMOVED***
