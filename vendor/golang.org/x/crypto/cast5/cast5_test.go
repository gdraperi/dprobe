...
func TestBasic(t *testing.T) ***REMOVED***
	for i, test := range basicTests ***REMOVED***
...
func TestFull(t *testing.T) ***REMOVED***
	...
	***REMOVED***
	...
	if hex.EncodeToString(a) != expectedA ***REMOVED***
		t.Errorf("a: got:%x want:%s", a, expectedA)
	***REMOVED***
	if hex.EncodeToString(b) != expectedB ***REMOVED***
		t.Errorf("b: got:%x want:%s", b, expectedB)
	***REMOVED***
***REMOVED***

func iterate(iterations int) ([]byte, []byte) ***REMOVED***
...
func TestLimited(t *testing.T) ***REMOVED***
	a, b := iterate(1000)
