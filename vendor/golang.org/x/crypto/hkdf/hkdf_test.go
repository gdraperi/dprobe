...
var hkdfTests = []hkdfTest***REMOVED***
	// Tests from RFC 5869
	***REMOVED***
		sha256.New,
		[]byte***REMOVED***
...
func TestHKDF(t *testing.T) ***REMOVED***
	for i, tt := range hkdfTests ***REMOVED***
		...
		if n != len(tt.out) || err != nil ***REMOVED***
			t.Errorf("test %d: not enough output bytes: %d.", i, n)
		***REMOVED***

		if !bytes.Equal(out, tt.out) ***REMOVED***
			t.Errorf("test %d: incorrect output: have %v, need %v.", i, out, tt.out)
		***REMOVED***
	***REMOVED***
***REMOVED***

func TestHKDFMultiRead(t *testing.T) ***REMOVED***
	for i, tt := range hkdfTests ***REMOVED***
		hkdf := New(tt.hash, tt.master, tt.salt, tt.info)
		out := make([]byte, len(tt.out))

		for b := 0; b < len(tt.out); b++ ***REMOVED***
...
func TestHKDFLimit(t *testing.T) ***REMOVED***
	hash := sha1.New
	master := []byte***REMOVED***0x00, 0x01, 0x02, 0x03***REMOVED***
	info := []byte***REMOVED******REMOVED***
...
func Benchmark16ByteMD5Single(b *testing.B) ***REMOVED***
	benchmarkHKDFSingle(md5.New, 16, b)
***REMOVED***

func Benchmark20ByteSHA1Single(b *testing.B) ***REMOVED***
	benchmarkHKDFSingle(sha1.New, 20, b)
***REMOVED***

func Benchmark32ByteSHA256Single(b *testing.B) ***REMOVED***
	benchmarkHKDFSingle(sha256.New, 32, b)
***REMOVED***

func Benchmark64ByteSHA512Single(b *testing.B) ***REMOVED***
	benchmarkHKDFSingle(sha512.New, 64, b)
***REMOVED***

func Benchmark8ByteMD5Stream(b *testing.B) ***REMOVED***
	benchmarkHKDFStream(md5.New, 8, b)
***REMOVED***

func Benchmark16ByteMD5Stream(b *testing.B) ***REMOVED***
	benchmarkHKDFStream(md5.New, 16, b)
***REMOVED***

func Benchmark8ByteSHA1Stream(b *testing.B) ***REMOVED***
	benchmarkHKDFStream(sha1.New, 8, b)
***REMOVED***

func Benchmark20ByteSHA1Stream(b *testing.B) ***REMOVED***
	benchmarkHKDFStream(sha1.New, 20, b)
***REMOVED***

func Benchmark8ByteSHA256Stream(b *testing.B) ***REMOVED***
	benchmarkHKDFStream(sha256.New, 8, b)
***REMOVED***

func Benchmark32ByteSHA256Stream(b *testing.B) ***REMOVED***
	benchmarkHKDFStream(sha256.New, 32, b)
***REMOVED***

func Benchmark8ByteSHA512Stream(b *testing.B) ***REMOVED***
	benchmarkHKDFStream(sha512.New, 8, b)
***REMOVED***

func Benchmark64ByteSHA512Stream(b *testing.B) ***REMOVED***
	benchmarkHKDFStream(sha512.New, 64, b)
***REMOVED***

func benchmarkHKDFSingle(hasher func() hash.Hash, block int, b *testing.B) ***REMOVED***
	master := []byte***REMOVED***0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07***REMOVED***
	salt := []byte***REMOVED***0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17***REMOVED***
	info := []byte***REMOVED***0x20, 0x21, 0x22, 0x23, 0x24, 0x25, 0x26, 0x27***REMOVED***
	out := make([]byte, block)
...
func benchmarkHKDFStream(hasher func() hash.Hash, block int, b *testing.B) ***REMOVED***
	master := []byte***REMOVED***0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07***REMOVED***
	salt := []byte***REMOVED***0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17***REMOVED***
	info := []byte***REMOVED***0x20, 0x21, 0x22, 0x23, 0x24, 0x25, 0x26, 0x27***REMOVED***
	out := make([]byte, block)
