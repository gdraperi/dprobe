...
func detectCPUFeatures() ***REMOVED***
...
func isSet(bitpos uint, value uint32) bool ***REMOVED***
	return value&(1<<bitpos) != 0
***REMOVED***

// setupState writes a ChaCha20 input matrix to state. See
// https://tools.ietf.org/html/rfc7539#section-2.3.
func setupState(state *[16]uint32, key *[32]byte, nonce []byte) ***REMOVED***
	state[0] = 0x61707865
	state[1] = 0x3320646e
	state[2] = 0x79622d32
	state[3] = 0x6b206574
...
func (c *chacha20poly1305) open(dst, nonce, ciphertext, additionalData []byte) ([]byte, error) ***REMOVED***
	...
	***REMOVED***
	...
	if !chacha20Poly1305Open(out, state[:], ciphertext, additionalData) ***REMOVED***
