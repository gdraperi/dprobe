...
var (
	genKatPassword = []byte***REMOVED***
		0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01,
		0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01,
		0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01,
		0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01,
	***REMOVED***
	genKatSalt   = []byte***REMOVED***0x02, 0x02, 0x02, 0x02, 0x02, 0x02, 0x02, 0x02, 0x02, 0x02, 0x02, 0x02, 0x02, 0x02, 0x02, 0x02***REMOVED***
	genKatSecret = []byte***REMOVED***0x03, 0x03, 0x03, 0x03, 0x03, 0x03, 0x03, 0x03***REMOVED***
	genKatAAD    = []byte***REMOVED***0x04, 0x04, 0x04, 0x04, 0x04, 0x04, 0x04, 0x04, 0x04, 0x04, 0x04, 0x04***REMOVED***
)

func TestArgon2(t *testing.T) ***REMOVED***
	defer func(sse4 bool) ***REMOVED*** useSSE4 = sse4 ***REMOVED***(useSSE4)
...
func testArgon2d(t *testing.T) ***REMOVED***
	want := []byte***REMOVED***
...
func testArgon2id(t *testing.T) ***REMOVED***
	want := []byte***REMOVED***
...
func TestVectors(t *testing.T) ***REMOVED***
	...
	for i, v := range testVectors ***REMOVED***
...
func benchmarkArgon2(mode int, time, memory uint32, threads uint8, keyLen uint32, b *testing.B) ***REMOVED***
...
func BenchmarkArgon2i(b *testing.B) ***REMOVED***
	b.Run(" Time: 3 Memory: 32 MB, Threads: 1", func(b *testing.B) ***REMOVED*** benchmarkArgon2(argon2i, 3, 32*1024, 1, 32, b) ***REMOVED***)
	b.Run(" Time: 4 Memory: 32 MB, Threads: 1", func(b *testing.B) ***REMOVED*** benchmarkArgon2(argon2i, 4, 32*1024, 1, 32, b) ***REMOVED***)
	b.Run(" Time: 5 Memory: 32 MB, Threads: 1", func(b *testing.B) ***REMOVED*** benchmarkArgon2(argon2i, 5, 32*1024, 1, 32, b) ***REMOVED***)
	b.Run(" Time: 3 Memory: 64 MB, Threads: 4", func(b *testing.B) ***REMOVED*** benchmarkArgon2(argon2i, 3, 64*1024, 4, 32, b) ***REMOVED***)
	b.Run(" Time: 4 Memory: 64 MB, Threads: 4", func(b *testing.B) ***REMOVED*** benchmarkArgon2(argon2i, 4, 64*1024, 4, 32, b) ***REMOVED***)
	b.Run(" Time: 5 Memory: 64 MB, Threads: 4", func(b *testing.B) ***REMOVED*** benchmarkArgon2(argon2i, 5, 64*1024, 4, 32, b) ***REMOVED***)
***REMOVED***

func BenchmarkArgon2d(b *testing.B) ***REMOVED***
	b.Run(" Time: 3, Memory: 32 MB, Threads: 1", func(b *testing.B) ***REMOVED*** benchmarkArgon2(argon2d, 3, 32*1024, 1, 32, b) ***REMOVED***)
	b.Run(" Time: 4, Memory: 32 MB, Threads: 1", func(b *testing.B) ***REMOVED*** benchmarkArgon2(argon2d, 4, 32*1024, 1, 32, b) ***REMOVED***)
	b.Run(" Time: 5, Memory: 32 MB, Threads: 1", func(b *testing.B) ***REMOVED*** benchmarkArgon2(argon2d, 5, 32*1024, 1, 32, b) ***REMOVED***)
	b.Run(" Time: 3, Memory: 64 MB, Threads: 4", func(b *testing.B) ***REMOVED*** benchmarkArgon2(argon2d, 3, 64*1024, 4, 32, b) ***REMOVED***)
	b.Run(" Time: 4, Memory: 64 MB, Threads: 4", func(b *testing.B) ***REMOVED*** benchmarkArgon2(argon2d, 4, 64*1024, 4, 32, b) ***REMOVED***)
	b.Run(" Time: 5, Memory: 64 MB, Threads: 4", func(b *testing.B) ***REMOVED*** benchmarkArgon2(argon2d, 5, 64*1024, 4, 32, b) ***REMOVED***)
***REMOVED***

func BenchmarkArgon2id(b *testing.B) ***REMOVED***
	b.Run(" Time: 3, Memory: 32 MB, Threads: 1", func(b *testing.B) ***REMOVED*** benchmarkArgon2(argon2id, 3, 32*1024, 1, 32, b) ***REMOVED***)
	b.Run(" Time: 4, Memory: 32 MB, Threads: 1", func(b *testing.B) ***REMOVED*** benchmarkArgon2(argon2id, 4, 32*1024, 1, 32, b) ***REMOVED***)
	b.Run(" Time: 5, Memory: 32 MB, Threads: 1", func(b *testing.B) ***REMOVED*** benchmarkArgon2(argon2id, 5, 32*1024, 1, 32, b) ***REMOVED***)
	b.Run(" Time: 3, Memory: 64 MB, Threads: 4", func(b *testing.B) ***REMOVED*** benchmarkArgon2(argon2id, 3, 64*1024, 4, 32, b) ***REMOVED***)
	b.Run(" Time: 4, Memory: 64 MB, Threads: 4", func(b *testing.B) ***REMOVED*** benchmarkArgon2(argon2id, 4, 64*1024, 4, 32, b) ***REMOVED***)
	b.Run(" Time: 5, Memory: 64 MB, Threads: 4", func(b *testing.B) ***REMOVED*** benchmarkArgon2(argon2id, 5, 64*1024, 4, 32, b) ***REMOVED***)
***REMOVED***

// Generated with the CLI of https://github.com/P-H-C/phc-winner-argon2/blob/master/argon2-specs.pdf
var testVectors = []struct ***REMOVED***
	mode         int
	time, memory uint32
	threads      uint8
	hash         string
