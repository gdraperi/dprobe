...
func TestCore208(t *testing.T) ***REMOVED***
	in := [64]byte***REMOVED***
		...
		0xed, 0xeb, 0xc6, 0x8d, 0xb8, 0xb8, 0xc2, 0x5e***REMOVED***
...
func TestOutOfBoundsWrite(t *testing.T) ***REMOVED***
	// encrypted "0123456789"
	cipherText := []byte***REMOVED***170, 166, 196, 104, 175, 121, 68, 44, 174, 51***REMOVED***
	var counter [16]byte
	var key [32]byte
	want := "abcdefghij"
	plainText := []byte(want)
