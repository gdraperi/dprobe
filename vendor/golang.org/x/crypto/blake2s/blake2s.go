...
func New256(key []byte) (hash.Hash, error) ***REMOVED*** return newDigest(Size, key) ***REMOVED***
...
// is not optional.
func New128(key []byte) (hash.Hash, error) ***REMOVED***
