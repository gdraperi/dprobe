...
func TestPfx(t *testing.T) ***REMOVED***
	for commonName, base64P12 := range testdata ***REMOVED***
...
func TestPEM(t *testing.T) ***REMOVED***
	for commonName, base64P12 := range testdata ***REMOVED***
		...
		***REMOVED***
		...
		if _, exists := config.NameToCertificate[commonName]; !exists ***REMOVED***
			t.Errorf("did not find our cert in PEM?: %v", config.NameToCertificate)
		***REMOVED***
	***REMOVED***
***REMOVED***

func ExampleToPEM() ***REMOVED***
...
var testdata = map[string]string***REMOVED***
