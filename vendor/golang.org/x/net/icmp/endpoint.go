...
var _ net.PacketConn = &PacketConn***REMOVED******REMOVED***
...
func (c *PacketConn) ok() bool ***REMOVED*** return c != nil && c.c != nil ***REMOVED***

// IPv4PacketConn returns the ipv4.PacketConn of c.
// It returns nil when c is not created as the endpoint for ICMPv4.
func (c *PacketConn) IPv4PacketConn() *ipv4.PacketConn ***REMOVED***
	if !c.ok() ***REMOVED***
		return nil
	***REMOVED***
	return c.p4
...
func (c *PacketConn) IPv6PacketConn() *ipv6.PacketConn ***REMOVED***
	if !c.ok() ***REMOVED***
		return nil
	***REMOVED***
	return c.p6
...
func (c *PacketConn) ReadFrom(b []byte) (int, net.Addr, error) ***REMOVED***
	if !c.ok() ***REMOVED***
	...
	***REMOVED***
	...
	if runtime.GOOS == "darwin" && c.p4 != nil ***REMOVED***
...
func (c *PacketConn) WriteTo(b []byte, dst net.Addr) (int, error) ***REMOVED***
	if !c.ok() ***REMOVED***
...
func (c *PacketConn) LocalAddr() net.Addr ***REMOVED***
	if !c.ok() ***REMOVED***
		return nil
	***REMOVED***
