...
// On Linux, a batch read will be optimized.
// On other platforms, this method will read only a single message.
func (c *packetHandler) ReadBatch(ms []Message, flags int) (int, error) ***REMOVED***
	if !c.ok() ***REMOVED***
		return 0, syscall.EINVAL
	***REMOVED***
	switch runtime.GOOS ***REMOVED***
	case "linux":
		n, err := c.RecvMsgs([]socket.Message(ms), flags)
		if err != nil ***REMOVED***
			err = &net.OpError***REMOVED***Op: "read", Net: c.IPConn.LocalAddr().Network(), Source: c.IPConn.LocalAddr(), Err: err***REMOVED***
		***REMOVED***
		return n, err
	default:
		n := 1
...
// On Linux, a batch write will be optimized.
// On other platforms, this method will write only a single message.
func (c *packetHandler) WriteBatch(ms []Message, flags int) (int, error) ***REMOVED***
	if !c.ok() ***REMOVED***
		return 0, syscall.EINVAL
	***REMOVED***
	switch runtime.GOOS ***REMOVED***
	case "linux":
		n, err := c.SendMsgs([]socket.Message(ms), flags)
		if err != nil ***REMOVED***
			err = &net.OpError***REMOVED***Op: "write", Net: c.IPConn.LocalAddr().Network(), Source: c.IPConn.LocalAddr(), Err: err***REMOVED***
		***REMOVED***
		return n, err
	default:
		n := 1
