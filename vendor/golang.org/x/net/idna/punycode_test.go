...
var punycodeTestCases = [...]struct ***REMOVED***
	s, encoded string
***REMOVED******REMOVED***
	***REMOVED***"", ""***REMOVED***,
	***REMOVED***"-", "--"***REMOVED***,
	...
	***REMOVED***"bücher", "bcher-kva"***REMOVED***,
	***REMOVED***"Hello世界", "Hello-ck1hg65u"***REMOVED***,
	***REMOVED***"ü", "tda"***REMOVED***,
	***REMOVED***"üý", "tdac"***REMOVED***,
...
func TestPunycode(t *testing.T) ***REMOVED***
	for _, tc := range punycodeTestCases ***REMOVED***
		if got, err := decode(tc.encoded); err != nil ***REMOVED***
			t.Errorf("decode(%q): %v", tc.encoded, err)
		***REMOVED*** else if got != tc.s ***REMOVED***
			t.Errorf("decode(%q): got %q, want %q", tc.encoded, got, tc.s)
		***REMOVED***

		if got, err := encode("", tc.s); err != nil ***REMOVED***
			t.Errorf(`encode("", %q): %v`, tc.s, err)
		***REMOVED*** else if got != tc.encoded ***REMOVED***
			t.Errorf(`encode("", %q): got %q, want %q`, tc.s, got, tc.encoded)
		***REMOVED***
	***REMOVED***
***REMOVED***

var punycodeErrorTestCases = [...]string***REMOVED***
...
func TestPunycodeErrors(t *testing.T) ***REMOVED***
	for _, tc := range punycodeErrorTestCases ***REMOVED***
		var err error
		switch ***REMOVED***
