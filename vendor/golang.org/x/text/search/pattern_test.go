...
func TestCompile(t *testing.T) ***REMOVED***
	...
	***REMOVED***, ***REMOVED***
		...
		pattern: "a\u0300", // U+0300: COMBINING GRAVE ACCENT
		options: []Option***REMOVED***IgnoreDiacritics***REMOVED***,
		n:       1,
	***REMOVED***, ***REMOVED***
...
func TestNorm(t *testing.T) ***REMOVED***
	...
	***REMOVED******REMOVED*** ***REMOVED***
		...
		if got := reflect.DeepEqual(a, b); got != tc.want ***REMOVED***
			t.Errorf("Compile(a) == Compile(b) == %v; want %v", got, tc.want)
		***REMOVED***
	***REMOVED***
***REMOVED***

func TestForwardSearch(t *testing.T) ***REMOVED***
	for i, tc := range []struct ***REMOVED***
		desc    string
		tag     string
		options []Option
	...
	***REMOVED******REMOVED******REMOVED***
		...
		pattern: "",
		text:    "",
		want:    nil, // TODO: consider: []int***REMOVED***0, 0***REMOVED***,
	***REMOVED***, ***REMOVED***
	...
	***REMOVED***, ***REMOVED***
		...
		pattern: "",
		text:    "abc",
		want:    nil, // TODO: consider: []int***REMOVED***0, 0, 1, 1, 2, 2, 3, 3***REMOVED***,
	***REMOVED***, ***REMOVED***
		...
		pattern: " ",
		text:    " ",
		want:    []int***REMOVED***0, 1***REMOVED***,
	***REMOVED***, ***REMOVED***
		desc:    "variables not handled by default",
		tag:     "und",
		pattern: "- ",
		text:    " -",
		want:    nil, // Would be (1, 2) for a median match with variable***REMOVED***.
	***REMOVED***, ***REMOVED***
		desc:    "multiple subsequent identical variables",
		tag:     "und",
		pattern: " ",
		text:    "    ",
		want:    []int***REMOVED***0, 1, 1, 2, 2, 3, 3, 4***REMOVED***,
	***REMOVED***, ***REMOVED***
	...
	***REMOVED***, ***REMOVED***
		...
		want:    []int***REMOVED***2, 7***REMOVED***, // Would have 3 matches using variable.
	...
	***REMOVED***, ***REMOVED***
		...
		pattern: "Abc",
		text:    "abcAbcABCÁbcábc",
		want:    []int***REMOVED***3, 6, 9, 13***REMOVED***,
	***REMOVED***, ***REMOVED***
		desc:    "ignore case",
		tag:     "und",
		options: []Option***REMOVED***IgnoreCase***REMOVED***,
		pattern: "Abc",
		text:    "abcAbcABCÁbcábc",
		want:    []int***REMOVED***0, 3, 3, 6, 6, 9***REMOVED***,
	***REMOVED***, ***REMOVED***
		desc:    "ignore case and diacritics",
		tag:     "und",
		options: []Option***REMOVED***IgnoreCase, IgnoreDiacritics***REMOVED***,
		pattern: "Abc",
		text:    "abcAbcABCÁbcábc",
		want:    []int***REMOVED***0, 3, 3, 6, 6, 9, 9, 13, 13, 17***REMOVED***,
	***REMOVED***, ***REMOVED***
		desc:    "ignore width to fullwidth",
		tag:     "und",
		options: []Option***REMOVED***IgnoreWidth***REMOVED***,
		pattern: "abc",
		text:    "123 \uFF41\uFF42\uFF43 123", // U+FF41-3: FULLWIDTH LATIN SMALL LETTER A-C
		want:    []int***REMOVED***4, 13***REMOVED***,
	***REMOVED***, ***REMOVED***
	...
	***REMOVED***, ***REMOVED***
		...
		tag:     "und",
		options: []Option***REMOVED***IgnoreWidth, IgnoreDiacritics***REMOVED***,
		pattern: "abc",
		text:    "123 \uFF41\uFF42\uFF43 123", // U+FF41-3: FULLWIDTH LATIN SMALL LETTER A-C
		want:    []int***REMOVED***4, 13***REMOVED***,
	***REMOVED***, ***REMOVED***
	...
	***REMOVED***, ***REMOVED***
		...
		want:    []int***REMOVED***0, 6, 6, 12, 14, 20***REMOVED***,
	***REMOVED***, ***REMOVED***
		desc:    "",
		tag:     "da",
		options: []Option***REMOVED***IgnoreCase***REMOVED***,
		pattern: "Aarhus",
		text:    "Århus Aarhus",
		want:    []int***REMOVED***0, 6, 7, 13***REMOVED***,
	***REMOVED***, ***REMOVED***
		desc:    "",
	...
	***REMOVED***, ***REMOVED***
		...
		pattern: "eee",
		text:    "123 eee\u0300 123", // U+0300: COMBINING GRAVE ACCENT
		want:    []int***REMOVED***4, 9***REMOVED***,         // Matches on grapheme boundary.
	***REMOVED***, ***REMOVED***
		...
		want:    []int***REMOVED***4, 11***REMOVED***,              // Matches on grapheme boundary.
	***REMOVED***, ***REMOVED***
	...
	***REMOVED******REMOVED*** ***REMOVED***
		...
		for j := 0; j < len(tc.text); ***REMOVED***
			...
			***REMOVED***
			...
			j = end
			if len(tc.want) == 0 ***REMOVED***
				t.Errorf("%d:%s: found unexpected result [%d %d]", i, tc.desc, start, end)
				break
			***REMOVED***
			if tc.want[0] != start || tc.want[1] != end ***REMOVED***
