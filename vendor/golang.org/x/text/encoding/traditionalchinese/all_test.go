...
func TestNonRepertoire(t *testing.T) ***REMOVED***
	testCases := []struct ***REMOVED***
		...
		src, want string
	***REMOVED******REMOVED***
		***REMOVED***dec, Big5, "\x80", "\ufffd"***REMOVED***,
		***REMOVED***dec, Big5, "\x81", "\ufffd"***REMOVED***,
		***REMOVED***dec, Big5, "\x81\x30", "\ufffd\x30"***REMOVED***,
		***REMOVED***dec, Big5, "\x81\x40", "\ufffd"***REMOVED***,
		***REMOVED***dec, Big5, "\x81\xa0", "\ufffd"***REMOVED***,
		***REMOVED***dec, Big5, "\xff", "\ufffd"***REMOVED***,

		***REMOVED***enc, Big5, "갂", ""***REMOVED***,
		***REMOVED***enc, Big5, "a갂", "a"***REMOVED***,
		***REMOVED***enc, Big5, "\u43f0갂", "\x87@"***REMOVED***,
	***REMOVED***
...
func TestFiles(t *testing.T) ***REMOVED*** enctest.TestFile(t, Big5) ***REMOVED***

func BenchmarkEncoding(b *testing.B) ***REMOVED*** enctest.Benchmark(b, Big5) ***REMOVED***
...
func TestBig5CircumflexAndMacron(t *testing.T) ***REMOVED***
	...
	if err != nil ***REMOVED***
		t.Fatal(err)
	***REMOVED***
	if got := string(dst); got != want ***REMOVED***
		t.Fatalf("\ngot  %q\nwant %q", got, want)
	***REMOVED***
***REMOVED***
