...
func printGB18030() ***REMOVED***
	...
	***REMOVED***
	...
	fmt.Printf("var gb18030 = [...][2]uint16***REMOVED***\n")
	...
	for scanner.Scan() ***REMOVED***
		...
		***REMOVED***
		if x < 0x10000 && y < 0x10000 ***REMOVED***
			fmt.Printf("\t***REMOVED***0x%04x, 0x%04x***REMOVED***,\n", x, y)
		***REMOVED***
	***REMOVED***
	fmt.Printf("***REMOVED***\n\n")
***REMOVED***

func printGBK() ***REMOVED***
