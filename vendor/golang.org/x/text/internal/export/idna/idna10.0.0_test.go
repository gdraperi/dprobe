...
func TestLabelErrors(t *testing.T) ***REMOVED***
	...
	***REMOVED******REMOVED***
		...
		***REMOVED***lengthA, ".b", ".b", "A4"***REMOVED***,
		***REMOVED***lengthA, "\u3002b", ".b", "A4"***REMOVED***,
		***REMOVED***lengthA, "..b", "..b", "A4"***REMOVED***,
		...
		***REMOVED***lengthA, "\ufe05\u3002\u3002\U0002603e\u1ce0", "..xn--t6f5138v", "A4"***REMOVED***,
		***REMOVED***lengthA, "FAX\u2a77\U0001d186\u3002\U0001e942\U000e0181\u180c", "", "B6"***REMOVED***,
		...
		***REMOVED***resolve, "..b", "..b", ""***REMOVED***,
		***REMOVED***resolve, "b..", "b..", ""***REMOVED***,
		***REMOVED***resolve, "\xed", "", "P1"***REMOVED***,
