...
1. Basic gocode autocompletion. I did my best presenting the results to the user. Maybe it's possible to improve that part a bit, not quite sure yet. For functions I use "***REMOVED*****class*****REMOVED*** ***REMOVED*****name*****REMOVED***\t***REMOVED*****returns*****REMOVED***", for everything else "***REMOVED*****class*****REMOVED*** ***REMOVED*****name*****REMOVED***\t***REMOVED*****type*****REMOVED***". In addition to that functions are properly augmented with argument snippets.
