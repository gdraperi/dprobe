...
***REMOVED***  
    ...
    ***REMOVED***,
        ...
        "Volumes": ***REMOVED***
            "/var/job-result-data": ***REMOVED******REMOVED***,
            "/var/log/my-app-logs": ***REMOVED******REMOVED***,
    ***REMOVED***,
    ...
    <dd>
        ...
        <dl>
            ...
            <dd>
                ...
                <code>map[string]struct***REMOVED******REMOVED***</code> and is represented in JSON as
                an object mapping its keys to an empty object. Here is an
                example:

<pre>***REMOVED***
    "8080": ***REMOVED******REMOVED***,
    "53/udp": ***REMOVED******REMOVED***,
    "2356/tcp": ***REMOVED******REMOVED***
***REMOVED***</pre>
...
***REMOVED***</pre>
            ...
            <dd>
                ...
                type <code>map[string]struct***REMOVED******REMOVED***</code> and is represented in
                JSON as an object mapping its keys to an empty object. Here is
                an example:
<pre>***REMOVED***
    "/var/my-app-data/": ***REMOVED******REMOVED***,
    "/etc/some-config.d/": ***REMOVED******REMOVED***,
***REMOVED***</pre>
            </dd>
            <dt>
