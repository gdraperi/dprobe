...
flushed (automatically and asynchronously) to the Stackdriver Logging service.
	...
	lg.Log(logging.Entry***REMOVED***Payload: "something happened!"***REMOVED***)
...
not recommended for basic use.
	...
	lg.LogSync(ctx, logging.Entry***REMOVED***Payload: "ALERT! Something critical happened!"***REMOVED***)
