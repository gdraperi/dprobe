...
func IsRFC(rfcNum uint, sa SockAddr) bool ***REMOVED***
	rfcNetMap := KnownRFCs()
...
func KnownRFCs() map[uint]SockAddrs ***REMOVED***
	...
	return map[uint]SockAddrs***REMOVED***
		...
		***REMOVED***,
		ForwardingBlacklist: ***REMOVED*** // Pseudo-RFC
...
func VisitAllRFCs(fn func(rfcNum uint, sockaddrs SockAddrs)) ***REMOVED***
	rfcNetMap := KnownRFCs()

	// Blacklist of faux-RFCs.  Don't show the world that we're abusing the
	// RFC system in this library.
	rfcBlacklist := map[uint]struct***REMOVED******REMOVED******REMOVED***
		ForwardingBlacklist: ***REMOVED******REMOVED***,
	***REMOVED***

	for rfcNum, sas := range rfcNetMap ***REMOVED***
		if _, found := rfcBlacklist[rfcNum]; !found ***REMOVED***
			fn(rfcNum, sas)
		***REMOVED***
	***REMOVED***
***REMOVED***
