...
func (s SockAddrs) Len() int      ***REMOVED*** return len(s) ***REMOVED***
func (s SockAddrs) Swap(i, j int) ***REMOVED*** s[i], s[j] = s[j], s[i] ***REMOVED***
...
type multiAddrSorter struct ***REMOVED***
	addrs SockAddrs
	cmp   []CmpAddrFunc
***REMOVED***
...
// OrderedAddrBy.
func (ms *multiAddrSorter) Sort(sockAddrs SockAddrs) ***REMOVED***
	ms.addrs = sockAddrs
	sort.Sort(ms)
***REMOVED***

// OrderedAddrBy sorts SockAddr by the list of sort function pointers.
func OrderedAddrBy(cmpFuncs ...CmpAddrFunc) *multiAddrSorter ***REMOVED***
	return &multiAddrSorter***REMOVED***
		cmp: cmpFuncs,
	***REMOVED***
***REMOVED***

// Len is part of sort.Interface.
func (ms *multiAddrSorter) Len() int ***REMOVED***
	return len(ms.addrs)
***REMOVED***
...
func (ms *multiAddrSorter) Less(i, j int) bool ***REMOVED***
...
func (ms *multiAddrSorter) Swap(i, j int) ***REMOVED***
...
func AscAddress(p1Ptr, p2Ptr *SockAddr) int ***REMOVED***
	p1 := *p1Ptr
	p2 := *p2Ptr

	switch v := p1.(type) ***REMOVED***
	case IPv4Addr:
...
func AscPort(p1Ptr, p2Ptr *SockAddr) int ***REMOVED***
	p1 := *p1Ptr
	p2 := *p2Ptr
...
func AscPrivate(p1Ptr, p2Ptr *SockAddr) int ***REMOVED***
	p1 := *p1Ptr
	p2 := *p2Ptr
...
func AscNetworkSize(p1Ptr, p2Ptr *SockAddr) int ***REMOVED***
	p1 := *p1Ptr
	p2 := *p2Ptr
	p1Type := p1.Type()
	p2Type := p2.Type()
	...
	if p1Type != p2Type && p1Type != TypeIP ***REMOVED***
		return sortDeferDecision
	***REMOVED***
...
// "less-secure" types.
func AscType(p1Ptr, p2Ptr *SockAddr) int ***REMOVED***
	p1 := *p1Ptr
	p2 := *p2Ptr
	p1Type := p1.Type()
	p2Type := p2.Type()
...
func (sas SockAddrs) FilterByType(type_ SockAddrType) (matched, excluded SockAddrs) ***REMOVED***
	matched = make(SockAddrs, 0, len(sas))
	excluded = make(SockAddrs, 0, len(sas))

	for _, sa := range sas ***REMOVED***
		if sa.Type()&type_ != 0 ***REMOVED***
