...
// array using To4().
func NewIPv6Addr(ipv6Str string) (IPv6Addr, error) ***REMOVED***
	v6Addr := false
LOOP:
	for i := 0; i < len(ipv6Str); i++ ***REMOVED***
		switch ipv6Str[i] ***REMOVED***
		case '.':
			break LOOP
		case ':':
			v6Addr = true
	...
	***REMOVED***
	...
	if !v6Addr ***REMOVED***
		return IPv6Addr***REMOVED******REMOVED***, fmt.Errorf("Unable to resolve %+q as an IPv6 address, appears to be an IPv4 address", ipv6Str)
	***REMOVED***
	...
	if err == nil ***REMOVED***
		...
		if ipv6 == nil ***REMOVED***
			return IPv6Addr***REMOVED******REMOVED***, fmt.Errorf("Unable to resolve %+q as a 16byte IPv6 address", ipv6Str)
		***REMOVED***
	...
	***REMOVED***
	...
	if len(ipv6Str) > 2 && ipv6Str[0] == '[' && ipv6Str[len(ipv6Str)-1] == ']' ***REMOVED***
	...
	***REMOVED***
	...
	if ip != nil ***REMOVED***
		ipv6 := ip.To16()
		if ipv6 == nil ***REMOVED***
			return IPv6Addr***REMOVED******REMOVED***, fmt.Errorf("Unable to string convert %+q to a 16byte IPv6 address", ipv6Str)
		***REMOVED***
	...
	***REMOVED***
	...
	if err == nil ***REMOVED***
		ipv6 := ipAddr.To16()
		if ipv6 == nil ***REMOVED***
			return IPv6Addr***REMOVED******REMOVED***, fmt.Errorf("Unable to convert %+q to a 16byte IPv6 address", ipv6Str)
		***REMOVED***
	...
	***REMOVED***
	...
	return IPv6Addr***REMOVED******REMOVED***, fmt.Errorf("Unable to parse %+q to an IPv6 address: %v", ipv6Str, err)
***REMOVED***
...
func (ipv6 IPv6Addr) AddressBinString() string ***REMOVED***
...
func (ipv6 IPv6Addr) AddressHexString() string ***REMOVED***
	bi := big.Int(*ipv6.Address)
...
func (ipv6 IPv6Addr) CmpAddress(sa SockAddr) int ***REMOVED***
...
//   regardless of type.
// - 1 If the argument should sort first.
func (ipv6 IPv6Addr) CmpPort(sa SockAddr) int ***REMOVED***
	var saPort IPPort
...
func (ipv6 IPv6Addr) CmpRFC(rfcNum uint, sa SockAddr) int ***REMOVED***
...
func (ipv6 IPv6Addr) Contains(sa SockAddr) bool ***REMOVED***
	ipv6b, ok := sa.(IPv6Addr)
	if !ok ***REMOVED***
		return false
	***REMOVED***
...
// receiver.
func (ipv6 IPv6Addr) ContainsAddress(x IPv6Address) bool ***REMOVED***
	xAddr := IPv6Addr***REMOVED***
		Address: x,
		Mask:    ipv6HostMask,
	***REMOVED***
	...
	***REMOVED***
		...
		if xIPv6.CmpAddress(yIPv6) >= 1 ***REMOVED***
			return false
		***REMOVED***
	***REMOVED***
...
// the receiver.
func (x IPv6Addr) ContainsNetwork(y IPv6Addr) bool ***REMOVED***
	***REMOVED***
		xIPv6 := x.FirstUsable().(IPv6Addr)
		yIPv6 := y.FirstUsable().(IPv6Addr)
		if ret := xIPv6.CmpAddress(yIPv6); ret >= 1 ***REMOVED***
			return false
		***REMOVED***
	***REMOVED***
...
// mask set to /128.
func (ipv6 IPv6Addr) DialPacketArgs() (network, dialArgs string) ***REMOVED***
	ipv6Mask := big.Int(*ipv6.Mask)
	if ipv6Mask.Cmp(ipv6HostMask) != 0 || ipv6.Port == 0 ***REMOVED***
		return "udp6", ""
	***REMOVED***
...
// mask set to /128.
func (ipv6 IPv6Addr) DialStreamArgs() (network, dialArgs string) ***REMOVED***
	ipv6Mask := big.Int(*ipv6.Mask)
	if ipv6Mask.Cmp(ipv6HostMask) != 0 || ipv6.Port == 0 ***REMOVED***
		return "tcp6", ""
	***REMOVED***
...
func (ipv6a IPv6Addr) Equal(sa SockAddr) bool ***REMOVED***
	ipv6b, ok := sa.(IPv6Addr)
	if !ok ***REMOVED***
		return false
	***REMOVED***

	if ipv6a.NetIP().String() != ipv6b.NetIP().String() ***REMOVED***
		return false
	***REMOVED***

	if ipv6a.NetIPNet().String() != ipv6b.NetIPNet().String() ***REMOVED***
		return false
	***REMOVED***

	if ipv6a.Port != ipv6b.Port ***REMOVED***
		return false
	***REMOVED***
...
func (ipv6 IPv6Addr) FirstUsable() IPAddr ***REMOVED***
	return IPv6Addr***REMOVED***
...
// ListenStreamArgs().
func (ipv6 IPv6Addr) Host() IPAddr ***REMOVED***
...
func (ipv6 IPv6Addr) IPPort() IPPort ***REMOVED***
	return ipv6.Port
***REMOVED***

// LastUsable returns the last address in a given network.
func (ipv6 IPv6Addr) LastUsable() IPAddr ***REMOVED***
	addr := new(big.Int)
...
func (ipv6 IPv6Addr) ListenPacketArgs() (network, listenArgs string) ***REMOVED***
	ipv6Mask := big.Int(*ipv6.Mask)
	if ipv6Mask.Cmp(ipv6HostMask) != 0 ***REMOVED***
		return "udp6", ""
	***REMOVED***
	return "udp6", fmt.Sprintf("[%s]:%d", ipv6.NetIP().String(), ipv6.Port)
***REMOVED***
...
// will fail.  See Host() to create an IPv6Addr with its mask set to /128.
func (ipv6 IPv6Addr) ListenStreamArgs() (network, listenArgs string) ***REMOVED***
	ipv6Mask := big.Int(*ipv6.Mask)
	if ipv6Mask.Cmp(ipv6HostMask) != 0 ***REMOVED***
		return "tcp6", ""
	***REMOVED***
...
func (ipv6 IPv6Addr) Maskbits() int ***REMOVED***
...
// invalid input.
func MustIPv6Addr(addr string) IPv6Addr ***REMOVED***
...
func (ipv6 IPv6Addr) NetIP() *net.IP ***REMOVED***
	return bigIntToNetIPv6(ipv6.Address)
***REMOVED***

// NetIPMask create a new net.IPMask from the IPv6Addr.
func (ipv6 IPv6Addr) NetIPMask() *net.IPMask ***REMOVED***
...
func (ipv6 IPv6Addr) NetIPNet() *net.IPNet ***REMOVED***
	ipv6net := &net.IPNet***REMOVED******REMOVED***
...
func (ipv6 IPv6Addr) Network() IPAddr ***REMOVED***
	return IPv6Addr***REMOVED***
		Address: IPv6Address(ipv6.NetworkAddress()),
		Mask:    ipv6.Mask,
	***REMOVED***
...
func (ipv6 IPv6Addr) NetworkAddress() IPv6Network ***REMOVED***
	addr := new(big.Int)
...
func (ipv6 IPv6Addr) Octets() []int ***REMOVED***
	x := make([]int, IPv6len)
	for i, b := range *bigIntToNetIPv6(ipv6.Address) ***REMOVED***
		x[i] = int(b)
	***REMOVED***
...
func (ipv6 IPv6Addr) String() string ***REMOVED***
	if ipv6.Port != 0 ***REMOVED***
		return fmt.Sprintf("[%s]:%d", ipv6.NetIP().String(), ipv6.Port)
	***REMOVED***

	if ipv6.Maskbits() == 128 ***REMOVED***
...
func ipv6AddrInit() ***REMOVED***
	// Sorted for human readability
	ipv6AddrAttrs = []AttrName***REMOVED***
		"size", // Same position as in IPv6 for output consistency
		"uint128",
	***REMOVED***

	ipv6AddrAttrMap = map[AttrName]func(ipv6 IPv6Addr) string***REMOVED***
		"size": func(ipv6 IPv6Addr) string ***REMOVED***
			netSize := big.NewInt(1)
			netSize = netSize.Lsh(netSize, uint(IPv6len*8-ipv6.Maskbits()))
			return netSize.Text(10)
		***REMOVED***,
		"uint128": func(ipv6 IPv6Addr) string ***REMOVED***
...
func bigIntToNetIPv6(bi *big.Int) *net.IP ***REMOVED***
	x := make(net.IP, IPv6len)
	ipv6Bytes := bi.Bytes()

	// It's possibe for ipv6Bytes to be less than IPv6len bytes in size.  If
	// they are different sizes we to pad the size of response.
	if len(ipv6Bytes) < IPv6len ***REMOVED***
		buf := new(bytes.Buffer)
		buf.Grow(IPv6len)

		for i := len(ipv6Bytes); i < IPv6len; i++ ***REMOVED***
			if err := binary.Write(buf, binary.BigEndian, byte(0)); err != nil ***REMOVED***
				panic(fmt.Sprintf("Unable to pad byte %d of input %v: %v", i, bi, err))
			***REMOVED***
		***REMOVED***

		for _, b := range ipv6Bytes ***REMOVED***
			if err := binary.Write(buf, binary.BigEndian, b); err != nil ***REMOVED***
