...
func NewHealthServer() *Server ***REMOVED***
...
func (s *Server) Check(ctx context.Context, in *api.HealthCheckRequest) (*api.HealthCheckResponse, error) ***REMOVED***
	s.mu.Lock()
	defer s.mu.Unlock()
	if in.Service == "" ***REMOVED***
		// check the server overall health status.
		return &api.HealthCheckResponse***REMOVED***
...
func (s *Server) SetServingStatus(service string, status api.HealthCheckResponse_ServingStatus) ***REMOVED***
	s.mu.Lock()
