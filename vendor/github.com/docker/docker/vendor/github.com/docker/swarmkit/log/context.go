...
func WithFields(ctx context.Context, fields logrus.Fields) context.Context ***REMOVED***
...
func WithField(ctx context.Context, key, value string) context.Context ***REMOVED***
	return WithFields(ctx, logrus.Fields***REMOVED***key: value***REMOVED***)
***REMOVED***
