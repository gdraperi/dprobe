...
type NodeDiscoveryData struct ***REMOVED***
	Address     string
	BindAddress string
	Self        bool
***REMOVED***
...
type DatastoreConfigData struct ***REMOVED***
	Scope    string
	Provider string
	Address  string
...
type DriverEncryptionConfig struct ***REMOVED***
	Keys [][]byte
	Tags []uint64
***REMOVED***
...
// Original key and tag types are []byte and uint64
type DriverEncryptionUpdate struct ***REMOVED***
	Key        []byte
	Tag        uint64
	Primary    []byte
	PrimaryTag uint64
