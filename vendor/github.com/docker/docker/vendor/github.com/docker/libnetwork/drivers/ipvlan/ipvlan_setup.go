...
func createIPVlan(containerIfName, parent, ipvlanMode string) (string, error) ***REMOVED***
	...
	***REMOVED***
	...
	ipvlan := &netlink.IPVlan***REMOVED***
		...
		***REMOVED***,
		Mode: mode,
	***REMOVED***
	if err := ns.NlHandle().LinkAdd(ipvlan); err != nil ***REMOVED***
...
func setIPVlanMode(mode string) (netlink.IPVlanMode, error) ***REMOVED***
	switch mode ***REMOVED***
	case modeL2:
