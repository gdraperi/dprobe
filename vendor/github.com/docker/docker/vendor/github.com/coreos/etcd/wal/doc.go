...
record it. So WAL can match with the saved snapshot when restarting.
	...
	err := w.SaveSnapshot(walpb.Snapshot***REMOVED***Index: 10, Term: 2***REMOVED***)
...
snapshot, an empty snapshot should be passed in.
	...
	w, err := wal.Open("/var/lib/etcd", walpb.Snapshot***REMOVED***Index: 10, Term: 2***REMOVED***)
	...
