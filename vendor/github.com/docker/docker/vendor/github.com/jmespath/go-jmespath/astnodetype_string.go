...
var _astNodeType_index = [...]uint16***REMOVED***0, 8, 21, 35, 44, 65, 73, 92, 102, 113, 121, 139, 152, 162, 180, 198, 213, 229, 245, 252, 265, 281, 289, 307***REMOVED***

func (i astNodeType) String() string ***REMOVED***
	if i < 0 || i >= astNodeType(len(_astNodeType_index)-1) ***REMOVED***
