...
func NewWriter(w io.Writer) *Writer ***REMOVED*** return &Writer***REMOVED***w: w, preferPax: true***REMOVED*** ***REMOVED***
...
func (tw *Writer) writeHeader(hdr *Header, allowPax bool) error ***REMOVED***
	...
	***REMOVED***
	var formatNumeric = func(b []byte, x int64, paxKeyword string) ***REMOVED***
		...
		***REMOVED***
		...
		f.formatNumeric(b, x)
	***REMOVED***
	var formatTime = func(b []byte, t time.Time, paxKeyword string) ***REMOVED***
		var unixTime int64
		...
		***REMOVED***
		...
		if paxKeyword != "" && tw.preferPax && allowPax && (t.Nanosecond() != 0 || !t.Before(minTime) || !t.After(maxTime)) ***REMOVED***
	...
	***REMOVED***
	...
	if allowPax ***REMOVED***
		...
		***REMOVED***
		if !hdr.CreationTime.IsZero() ***REMOVED***
...
func formatPAXTime(t time.Time) string ***REMOVED***
	sec := t.Unix()
	usec := t.Nanosecond()
