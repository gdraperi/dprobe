...
func (config *Config) TarToVhd(targetVHDFile string, reader io.Reader) (int64, error) ***REMOVED***
	...
	***REMOVED***
	...
	if _, err = copyWithTimeout(process.Stdin, reader, 0, config.UvmTimeoutSeconds, fmt.Sprintf("stdin of tar2vhd for generating %s", targetVHDFile)); err != nil ***REMOVED***
	...
	***REMOVED***
	...
	if err := process.Process.CloseStdin(); err != nil ***REMOVED***
