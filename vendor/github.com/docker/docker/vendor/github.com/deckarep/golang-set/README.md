...
scienceSlice := []interface***REMOVED******REMOVED******REMOVED***"Biology", "Chemistry"***REMOVED***
...
fmt.Println(allClasses) //Set***REMOVED***Cooking, English, Math, Chemistry, Welding, Biology, Music, Automotive, Go Programming, Python Programming***REMOVED***
...
fmt.Println(allClasses.Difference(scienceClasses)) //Set***REMOVED***Music, Automotive, Go Programming, Python Programming, Cooking, English, Math, Welding***REMOVED***

//Which science classes are also required classes?
fmt.Println(scienceClasses.Intersect(requiredClasses)) //Set***REMOVED***Biology***REMOVED***

//How many bonus classes do you offer?
fmt.Println(bonusClasses.Cardinality()) //2

//Do you have the following classes? Welding, Automotive and English?
fmt.Println(allClasses.IsSuperset(mapset.NewSetFromSlice([]interface***REMOVED******REMOVED******REMOVED***"Welding", "Automotive", "English"***REMOVED***))) //true
```
