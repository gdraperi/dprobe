...
func (m *Descriptor) Reset()                    ***REMOVED*** *m = Descriptor***REMOVED******REMOVED*** ***REMOVED***
func (*Descriptor) ProtoMessage()               ***REMOVED******REMOVED***
func (*Descriptor) Descriptor() ([]byte, []int) ***REMOVED*** return fileDescriptorDescriptor, []int***REMOVED***0***REMOVED*** ***REMOVED***

func init() ***REMOVED***
	proto.RegisterType((*Descriptor)(nil), "containerd.types.Descriptor")
***REMOVED***
func (m *Descriptor) Marshal() (dAtA []byte, err error) ***REMOVED***
	size := m.Size()
	dAtA = make([]byte, size)
...
func (m *Descriptor) MarshalTo(dAtA []byte) (int, error) ***REMOVED***
	var i int
	_ = i
	var l int
	_ = l
...
func encodeVarintDescriptor(dAtA []byte, offset int, v uint64) int ***REMOVED***
	for v >= 1<<7 ***REMOVED***
	...
	***REMOVED***
	...
	return offset + 1
***REMOVED***
func (m *Descriptor) Size() (n int) ***REMOVED***
	var l int
	_ = l
	l = len(m.MediaType)
	if l > 0 ***REMOVED***
...
func sovDescriptor(x uint64) (n int) ***REMOVED***
	for ***REMOVED***
		n++
		x >>= 7
		if x == 0 ***REMOVED***
	...
	***REMOVED***
	return n
***REMOVED***
func sozDescriptor(x uint64) (n int) ***REMOVED***
	return sovDescriptor(uint64((x << 1) ^ uint64((int64(x) >> 63))))
***REMOVED***
func (this *Descriptor) String() string ***REMOVED***
	if this == nil ***REMOVED***
		return "nil"
	***REMOVED***
	s := strings.Join([]string***REMOVED***`&Descriptor***REMOVED***`,
	...
	***REMOVED***, "")
	return s
***REMOVED***
func valueToStringDescriptor(v interface***REMOVED******REMOVED***) string ***REMOVED***
...
***REMOVED***
func (m *Descriptor) Unmarshal(dAtA []byte) error ***REMOVED***
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l ***REMOVED***
		preIndex := iNdEx
	...
	***REMOVED***
	return nil
***REMOVED***
func skipDescriptor(dAtA []byte) (n int, err error) ***REMOVED***
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l ***REMOVED***
		var wire uint64
