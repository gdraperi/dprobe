...
func (*Platform) Descriptor() ([]byte, []int) ***REMOVED*** return fileDescriptorPlatform, []int***REMOVED***0***REMOVED*** ***REMOVED***
...
func encodeVarintPlatform(dAtA []byte, offset int, v uint64) int ***REMOVED***
	for v >= 1<<7 ***REMOVED***
...
func sovPlatform(x uint64) (n int) ***REMOVED***
	for ***REMOVED***
		n++
		x >>= 7
		if x == 0 ***REMOVED***
	...
	***REMOVED***
	return n
***REMOVED***
func sozPlatform(x uint64) (n int) ***REMOVED***
...
func (this *Platform) String() string ***REMOVED***
	...
	***REMOVED***, "")
	return s
***REMOVED***
func valueToStringPlatform(v interface***REMOVED******REMOVED***) string ***REMOVED***
...
func (m *Platform) Unmarshal(dAtA []byte) error ***REMOVED***
	...
	***REMOVED***
	return nil
***REMOVED***
func skipPlatform(dAtA []byte) (n int, err error) ***REMOVED***
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l ***REMOVED***
		var wire uint64
...
var fileDescriptorPlatform = []byte***REMOVED***
