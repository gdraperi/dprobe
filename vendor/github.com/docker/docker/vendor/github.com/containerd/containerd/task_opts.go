...
func WithRootFS(mounts []mount.Mount) NewTaskOpts ***REMOVED***
	return func(ctx context.Context, c *Client, ti *TaskInfo) error ***REMOVED***
		ti.RootFS = mounts
		return nil
	***REMOVED***
***REMOVED***
...
func WithExit(r *CheckpointTaskInfo) error ***REMOVED***
	r.Options = &runctypes.CheckpointOptions***REMOVED***
		Exit: true,
	***REMOVED***
	return nil
***REMOVED***
...
func WithCheckpointName(name string) CheckpointTaskOpts ***REMOVED***
	return func(r *CheckpointTaskInfo) error ***REMOVED***
		r.Name = name
		return nil
	***REMOVED***
***REMOVED***
...
func WithProcessKill(ctx context.Context, p Process) error ***REMOVED***
	...
	if err != nil ***REMOVED***
		return err
	***REMOVED***
	if err := p.Kill(ctx, syscall.SIGKILL, WithKillAll); err != nil ***REMOVED***
		if errdefs.IsFailedPrecondition(err) || errdefs.IsNotFound(err) ***REMOVED***
			return nil
		***REMOVED***
		return err
	***REMOVED***
...
func WithKillAll(ctx context.Context, i *KillInfo) error ***REMOVED***
	i.All = true
	return nil
***REMOVED***

// WithKillExecID specifies the process ID
func WithKillExecID(execID string) KillOpts ***REMOVED***
	return func(ctx context.Context, i *KillInfo) error ***REMOVED***
		i.ExecID = execID
		return nil
	***REMOVED***
***REMOVED***
