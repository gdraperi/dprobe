...
func getxattr(path string, attr string, dest []byte, pos int, options int) (sz int, err error) ***REMOVED***
	var _p0 *byte
...
func listxattr(path string, dest []byte, options int) (sz int, err error) ***REMOVED***
	var _p0 *byte
	_p0, err = syscall.BytePtrFromString(path)
	if err != nil ***REMOVED***
		return
