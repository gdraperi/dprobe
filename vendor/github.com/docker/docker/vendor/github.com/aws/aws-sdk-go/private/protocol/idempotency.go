...
func CanSetIdempotencyToken(v reflect.Value, f reflect.StructField) bool ***REMOVED***
	switch u := v.Interface().(type) ***REMOVED***
...
func GetIdempotencyToken() string ***REMOVED***
	b := make([]byte, 16)
	RandReader.Read(b)
...
func SetIdempotencyToken(v reflect.Value) ***REMOVED***
	if v.Kind() == reflect.Ptr ***REMOVED***
		if v.IsNil() && v.CanSet() ***REMOVED***
...
func UUIDVersion4(u []byte) string ***REMOVED***
