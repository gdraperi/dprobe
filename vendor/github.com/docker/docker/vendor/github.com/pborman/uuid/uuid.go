...
func Parse(s string) UUID ***REMOVED***
	if len(s) == 36+9 ***REMOVED***
		if strings.ToLower(s[:9]) != "urn:uuid:" ***REMOVED***
			return nil
		***REMOVED***
		s = s[9:]
	***REMOVED*** else if len(s) != 36 ***REMOVED***
		return nil
	***REMOVED***
...
func Equal(uuid1, uuid2 UUID) bool ***REMOVED***
...
// valid.
func (uuid UUID) Version() (Version, bool) ***REMOVED***
	if len(uuid) != 16 ***REMOVED***
		return 0, false
	***REMOVED***
