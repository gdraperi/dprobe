...
func init() ***REMOVED***
	http.HandleFunc("/debug/requests", func(w http.ResponseWriter, req *http.Request) ***REMOVED***
	...
	***REMOVED***)
	http.HandleFunc("/debug/events", func(w http.ResponseWriter, req *http.Request) ***REMOVED***
		any, sensitive := AuthRequest(req)
		if !any ***REMOVED***
			http.Error(w, "not allowed", http.StatusUnauthorized)
			return
...
func (tr *trace) SetError() ***REMOVED*** tr.IsError = true ***REMOVED***
