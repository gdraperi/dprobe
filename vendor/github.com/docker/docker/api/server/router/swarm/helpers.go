...
func (sr *swarmRouter) swarmLogs(ctx context.Context, w io.Writer, r *http.Request, selector *backend.LogSelector) error ***REMOVED***
	...
	***REMOVED***
	...
	logsConfig := &basictypes.ContainerLogsOptions***REMOVED***
	...
	***REMOVED***
	...
	for _, service := range selector.Services ***REMOVED***
	...
	***REMOVED***
	for _, task := range selector.Tasks ***REMOVED***
