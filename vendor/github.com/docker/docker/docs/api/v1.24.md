...
**Example response**:
    ...
    [
         ***REMOVED***
                 ...
                 "State": "exited",
                 "Status": "Exit 0",
                 "Ports": [***REMOVED***"PrivatePort": 2222, "PublicPort": 3333, "Type": "tcp"***REMOVED***],
                 "Labels": ***REMOVED***
...
**Example request**:
    ...
    ***REMOVED***
       ...
       ***REMOVED***,
           ...
           "ExposedPorts": ***REMOVED***
                   "22/tcp": ***REMOVED******REMOVED***
       ***REMOVED***,
           "StopSignal": "SIGTERM",
           "HostConfig": ***REMOVED***
             "Binds": ["/tmp:/tmp"],
             "Tmpfs": ***REMOVED*** "/run": "rw,noexec,nosuid,size=65536k" ***REMOVED***,
             "Links": ["redis3:redis"],
             "Memory": 0,
             "MemorySwap": 0,
             "MemoryReservation": 0,
             ...
             "IOMaximumIOps": 0,
             "BlkioWeight": 300,
             "BlkioWeightDevice": [***REMOVED******REMOVED***],
             "BlkioDeviceReadBps": [***REMOVED******REMOVED***],
             "BlkioDeviceReadIOps": [***REMOVED******REMOVED***],
             "BlkioDeviceWriteBps": [***REMOVED******REMOVED***],
             "BlkioDeviceWriteIOps": [***REMOVED******REMOVED***],
             "MemorySwappiness": 60,
             "OomKillDisable": false,
             "OomScoreAdj": 500,
             "PidMode": "",
             "PidsLimit": -1,
             "PortBindings": ***REMOVED*** "22/tcp": [***REMOVED*** "HostPort": "11022" ***REMOVED***] ***REMOVED***,
             ...
             "CapDrop": ["MKNOD"],
             "GroupAdd": ["newgroup"],
             "RestartPolicy": ***REMOVED*** "Name": "", "MaximumRetryCount": 0 ***REMOVED***,
             "NetworkMode": "bridge",
             "Devices": [],
             "Sysctls": ***REMOVED*** "net.ipv4.ip_forward": "1" ***REMOVED***,
             "Ulimits": [***REMOVED******REMOVED***],
             "LogConfig": ***REMOVED*** "Type": "json-file", "Config": ***REMOVED******REMOVED*** ***REMOVED***,
             "SecurityOpt": [],
             "StorageOpt": ***REMOVED******REMOVED***,
             "CgroupParent": "",
             "VolumeDriver": "",
             "ShmSize": 67108864
      ***REMOVED***,
          "NetworkingConfig": ***REMOVED***
              "EndpointsConfig": ***REMOVED***
                  "isolated_nw" : ***REMOVED***
                      "IPAMConfig": ***REMOVED***
...
-   **Labels** - Adds a map of labels to a container. To specify a map: `***REMOVED***"key":"value", ... ***REMOVED***`
...
-   **Healthcheck** - A test to perform to check that the container is healthy.
    -     **Test** - The test to perform. Possible values are:
              + `***REMOVED******REMOVED***` inherit healthcheck from image or parent image
...
-   **ExposedPorts** - An object mapping ports to an empty object in the form of:
      `"ExposedPorts": ***REMOVED*** "<port>/<tcp|udp>: ***REMOVED******REMOVED***" ***REMOVED***`
...
-   **HostConfig**
    ...
    -   **Tmpfs** – A map of container directories which should be replaced by tmpfs mounts, and their corresponding
          mount options. A JSON object in the form `***REMOVED*** "/run": "rw,noexec,nosuid,size=65536k" ***REMOVED***`.
    ...
    -   **BlkioWeightDevice** - Block IO weight (relative device weight) in the form of:        `"BlkioWeightDevice": [***REMOVED***"Path": "device_path", "Weight": weight***REMOVED***]`
    -   **BlkioDeviceReadBps** - Limit read rate (bytes per second) from a device in the form of:	`"BlkioDeviceReadBps": [***REMOVED***"Path": "device_path", "Rate": rate***REMOVED***]`, for example:
        `"BlkioDeviceReadBps": [***REMOVED***"Path": "/dev/sda", "Rate": "1024"***REMOVED***]"`
    -   **BlkioDeviceWriteBps** - Limit write rate (bytes per second) to a device in the form of:	`"BlkioDeviceWriteBps": [***REMOVED***"Path": "device_path", "Rate": rate***REMOVED***]`, for example:
        `"BlkioDeviceWriteBps": [***REMOVED***"Path": "/dev/sda", "Rate": "1024"***REMOVED***]"`
    -   **BlkioDeviceReadIOps** - Limit read rate (IO per second) from a device in the form of:	`"BlkioDeviceReadIOps": [***REMOVED***"Path": "device_path", "Rate": rate***REMOVED***]`, for example:
        `"BlkioDeviceReadIOps": [***REMOVED***"Path": "/dev/sda", "Rate": "1000"***REMOVED***]`
    -   **BlkioDeviceWriteIOps** - Limit write rate (IO per second) to a device in the form of:	`"BlkioDeviceWriteIOps": [***REMOVED***"Path": "device_path", "Rate": rate***REMOVED***]`, for example:
        `"BlkioDeviceWriteIOps": [***REMOVED***"Path": "/dev/sda", "Rate": "1000"***REMOVED***]`
    ...
    -   **PortBindings** - A map of exposed container ports and the host port they
          ...
          `***REMOVED*** <port>/<protocol>: [***REMOVED*** "HostPort": "<port>" ***REMOVED***] ***REMOVED***`
    ...
    -   **Devices** - A list of devices to add to the container specified as a JSON object in the
      form
          `***REMOVED*** "PathOnHost": "/dev/deviceName", "PathInContainer": "/dev/deviceName", "CgroupPermissions": "mrw"***REMOVED***`
    -   **Ulimits** - A list of ulimits to set in the container, specified as
          `***REMOVED*** "Name": <name>, "Soft": <soft limit>, "Hard": <hard limit> ***REMOVED***`, for example:
          `Ulimits: ***REMOVED*** "Name": "nofile", "Soft": 1024, "Hard": 2048 ***REMOVED***`
    -   **Sysctls** - A list of kernel parameters (sysctls) to set in the container, specified as
          `***REMOVED*** <name>: <Value> ***REMOVED***`, for example:
	  `***REMOVED*** "net.ipv4.ip_forward": "1" ***REMOVED***`
    -   **SecurityOpt**: A list of string values to customize labels for MLS
        systems, such as SELinux.
    -   **StorageOpt**: Storage driver options per container. Options can be passed in the form
        `***REMOVED***"size":"120G"***REMOVED***`
    -   **LogConfig** - Log configuration for the container, specified as a JSON object in the form
          `***REMOVED*** "Type": "<driver_name>", "Config": ***REMOVED***"key1": "val1"***REMOVED******REMOVED***`.
...
**Example response**:
     ...
     ***REMOVED***% raw %***REMOVED***
     ***REMOVED******REMOVED*** STREAM ***REMOVED******REMOVED***
     ***REMOVED***% endraw %***REMOVED***
...
**Example response**:
    ...
    ***REMOVED***% raw %***REMOVED***
    ***REMOVED******REMOVED*** TAR STREAM ***REMOVED******REMOVED***
    ***REMOVED***% endraw %***REMOVED***
...
**Example response**:
     ...
     ***REMOVED***,
        ...
        ***REMOVED***,
            ...
            "throttling_data" : ***REMOVED***"periods":0,"throttled_periods":0,"throttled_time":0***REMOVED***
     ***REMOVED***,
         "precpu_stats" : ***REMOVED***
            "cpu_usage" : ***REMOVED***
               "percpu_usage" : [
                  8646879,
                  24350896,
...
It is encoded on the first eight bytes like this:
    ...
    header := [8]byte***REMOVED***STREAM_TYPE, 0, 0, 0, SIZE1, SIZE2, SIZE3, SIZE4***REMOVED***
...
**Example response**:
    ...
    ***REMOVED***"stream": "Step 1/5..."***REMOVED***
    ***REMOVED***"stream": "..."***REMOVED***
    ***REMOVED***"error": "Error...", "errorDetail": ***REMOVED***"code": 123, "message": "Error..."***REMOVED******REMOVED***
...
**Example response**:
    ...
    ***REMOVED***"status": "Pulling..."***REMOVED***
    ***REMOVED***"status": "Pulling", "progress": "1 B/ 100 B", "progressDetail": ***REMOVED***"current": 1, "total": 100***REMOVED******REMOVED***
    ***REMOVED***"error": "Invalid..."***REMOVED***
    ...
...
**Example response**:
    ...
    ***REMOVED***"status": "Pushing..."***REMOVED***
    ***REMOVED***"status": "Pushing", "progress": "1/? (n/a)", "progressDetail": ***REMOVED***"current": 1***REMOVED******REMOVED******REMOVED***
    ***REMOVED***"error": "Invalid..."***REMOVED***
    ...
...
**Example response**:
    ...
    [
     ***REMOVED***"Untagged": "3e2f21a89f"***REMOVED***,
     ***REMOVED***"Deleted": "3e2f21a89f"***REMOVED***,
     ***REMOVED***"Deleted": "53b4f83ac9"***REMOVED***
    ]
...
**Example response**:
    ...
    ***REMOVED***"Id": "596069db4bf5"***REMOVED***
...
**Example response**:
    ...
    ***REMOVED***"status":"Loading layer","progressDetail":***REMOVED***"current":32768,"total":1292800***REMOVED***,"progress":"[=                                                 ] 32.77 kB/1.293 MB","id":"8ac8bfaff55a"***REMOVED***
    ***REMOVED***"status":"Loading layer","progressDetail":***REMOVED***"current":65536,"total":1292800***REMOVED***,"progress":"[==                                                ] 65.54 kB/1.293 MB","id":"8ac8bfaff55a"***REMOVED***
    ***REMOVED***"status":"Loading layer","progressDetail":***REMOVED***"current":98304,"total":1292800***REMOVED***,"progress":"[===                                               ]  98.3 kB/1.293 MB","id":"8ac8bfaff55a"***REMOVED***
    ***REMOVED***"status":"Loading layer","progressDetail":***REMOVED***"current":131072,"total":1292800***REMOVED***,"progress":"[=====                                             ] 131.1 kB/1.293 MB","id":"8ac8bfaff55a"***REMOVED***
    ...
    ***REMOVED***"stream":"Loaded image: busybox:latest\n"***REMOVED***
...
```
***REMOVED***"hello-world":
    ***REMOVED***"latest": "565a9d68a73f6706862bfe8409a7f659776d4d60a8d096eb4a3cbce6999cc2a1"***REMOVED***
***REMOVED***
```
...
- **Labels** - Labels to set on the volume, specified as a map: `***REMOVED***"key":"value","key2":"value2"***REMOVED***`
...
- **Status** - Low-level details about the volume, provided by the volume driver.
    Details are returned as a map with key/value pairs: `***REMOVED***"key":"value","key2":"value2"***REMOVED***`.
    The `Status` field is optional, and is omitted if the volume driver does not
    support this feature.
- **Labels** - Labels set on the volume, specified as a map: `***REMOVED***"key":"value","key2":"value2"***REMOVED***`.
...
**Example request**:
    ...
    GET /v1.24/networks?filters=***REMOVED***"type":***REMOVED***"custom":true***REMOVED******REMOVED*** HTTP/1.1
...
***REMOVED***,
    "Containers": ***REMOVED***
      "39b69226f9d79f5634485fb236a23b2fe4e96a0a94128390a7fbbcc167065867": ***REMOVED***
...
***REMOVED***
  ***REMOVED***,
  "Internal": false,
  "Containers": ***REMOVED***
    "19a4d5d687db25203351ed79d478946f861258f018fe384f229f2efa4b23513c": ***REMOVED***
      "Name": "test",
...
- **IPAM** - Optional custom IP scheme for the network
  ...
  - **Config** - List of IPAM configuration options, specified as a map:
      `***REMOVED***"Subnet": <CIDR>, "IPRange": <CIDR>, "Gateway": <IP address>, "AuxAddress": <device_name:IP address>***REMOVED***`
  - **Options** - Driver-specific options, specified as a map: `***REMOVED***"option":"value" [,"option2":"value2"]***REMOVED***`
- **EnableIPv6** - Enable IPv6 on the network
- **Options** - Network specific options to be used by the drivers
- **Labels** - Labels to set on the network, specified as a map: `***REMOVED***"key":"value" [,"key2":"value2"]***REMOVED***`
...
**Example request**:
    ...
    ***REMOVED***
      ...
      "Spec": ***REMOVED***
        "Orchestration": ***REMOVED******REMOVED***,
        "Raft": ***REMOVED******REMOVED***,
        "Dispatcher": ***REMOVED******REMOVED***,
        "CAConfig": ***REMOVED******REMOVED***
  ***REMOVED***
***REMOVED***
...
**Example response**:
    ...
    ***REMOVED***,
        ...
        "Spec": ***REMOVED***
          "Name": "hopeful_cori",
          "TaskTemplate": ***REMOVED***
            "ContainerSpec": ***REMOVED***
              "Image": "redis"
        ***REMOVED***,
            "Resources": ***REMOVED***
              "Limits": ***REMOVED******REMOVED***,
              "Reservations": ***REMOVED******REMOVED***
        ***REMOVED***,
            "RestartPolicy": ***REMOVED***
              "Condition": "any",
              "MaxAttempts": 0
        ...
        "ContainerSpec": ***REMOVED***
          ...
          "Mounts": [
            ***REMOVED***
              ...
              "Type": "volume",
              "VolumeOptions": ***REMOVED***
                "DriverConfig": ***REMOVED***
            ***REMOVED***,
                "Labels": ***REMOVED***
...
- **Labels** – A map of labels to associate with the service (e.g., `***REMOVED***"key":"value", "key2":"value2"***REMOVED***`).
...
- **EndpointSpec** – Properties that can be configured to access and load balance a service.
    ...
    - **Ports** – List of exposed ports that this service is accessible on from
      ...
      `***REMOVED***"Protocol": <"tcp"|"udp">, "PublishedPort": <port>, "TargetPort": <port>***REMOVED***`.
    ...
    ***REMOVED***,
        ...
        "NetworksAttachments": [
          ...
          ***REMOVED***,
            ...
            ***REMOVED***,
                "DriverConfiguration": ***REMOVED******REMOVED***,
                "IPAMOptions": ***REMOVED***
