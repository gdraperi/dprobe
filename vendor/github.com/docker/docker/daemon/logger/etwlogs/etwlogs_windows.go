...
// 1. logman start -ets DockerContainerLogs -p ***REMOVED***a3693192-9ed6-46d2-a981-f8226c8363bd***REMOVED*** 0 0 -o trace.etl
...
func (etwLogger *etwLogs) Log(msg *logger.Message) error ***REMOVED***
	if providerHandle == windows.InvalidHandle ***REMOVED***
...
func (etwLogger *etwLogs) Close() error ***REMOVED***
	unregisterETWProvider()
	return nil
***REMOVED***

func (etwLogger *etwLogs) Name() string ***REMOVED***
	return name
***REMOVED***

func createLogMessage(etwLogger *etwLogs, msg *logger.Message) string ***REMOVED***
...
func registerETWProvider() error ***REMOVED***
	mu.Lock()
	defer mu.Unlock()
	if refCount == 0 ***REMOVED***
		var err error
		if err = callEventRegister(); err != nil ***REMOVED***
			return err
		***REMOVED***
	***REMOVED***
...
func unregisterETWProvider() ***REMOVED***
	mu.Lock()
	defer mu.Unlock()
	if refCount == 1 ***REMOVED***
		if callEventUnregister() ***REMOVED***
			refCount--
			providerHandle = windows.InvalidHandle
		***REMOVED***
...
func callEventRegister() error ***REMOVED***
	// The provider's GUID is ***REMOVED***a3693192-9ed6-46d2-a981-f8226c8363bd***REMOVED***
	guid := windows.GUID***REMOVED***
		Data1: 0xa3693192,
		Data2: 0x9ed6,
		Data3: 0x46d2,
		Data4: [8]byte***REMOVED***0xa9, 0x81, 0xf8, 0x22, 0x6c, 0x83, 0x63, 0xbd***REMOVED***,
	***REMOVED***

	ret, _, _ := procEventRegister.Call(uintptr(unsafe.Pointer(&guid)), 0, 0, uintptr(unsafe.Pointer(&providerHandle)))
	if ret != win32CallSuccess ***REMOVED***
...
func callEventWriteString(message string) error ***REMOVED***
...
func callEventUnregister() bool ***REMOVED***
