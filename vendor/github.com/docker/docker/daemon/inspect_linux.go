...
func (daemon *Daemon) containerInspectPre120(name string) (*v1p19.ContainerJSON, error) ***REMOVED***
	...
	***REMOVED***
	...
	config := &v1p19.ContainerConfig***REMOVED***
	...
	***REMOVED***
	...
	return &v1p19.ContainerJSON***REMOVED***
