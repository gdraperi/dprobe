...
func (s *DockerSuite) TestCreateArgs(c *check.C) ***REMOVED***
	...
	***REMOVED******REMOVED******REMOVED***
	...
	b := false
	expected := []string***REMOVED***"arg1", "arg2", "arg with space", "-c", "flags"***REMOVED***
	for i, arg := range expected ***REMOVED***
		if arg != cont.Args[i] ***REMOVED***
			b = true
			break
		***REMOVED***
	***REMOVED***
	if len(cont.Args) != len(expected) || b ***REMOVED***
...
func (s *DockerSuite) TestCreateGrowRootfs(c *check.C) ***REMOVED***
...
func (s *DockerSuite) TestCreateShrinkRootfs(c *check.C) ***REMOVED***
	testRequires(c, Devicemapper)
...
func (s *DockerSuite) TestCreateHostConfig(c *check.C) ***REMOVED***
...
func (s *DockerSuite) TestCreateWithPortRange(c *check.C) ***REMOVED***
	...
	***REMOVED******REMOVED******REMOVED***
	...
	for k, v := range cont.HostConfig.PortBindings ***REMOVED***
...
func (s *DockerSuite) TestCreateWithLargePortRange(c *check.C) ***REMOVED***
...
func (s *DockerSuite) TestCreateEchoStdout(c *check.C) ***REMOVED***
...
func (s *DockerSuite) TestCreateVolumesCreated(c *check.C) ***REMOVED***
	...
	if _, err := os.Stat(dir); err != nil && os.IsNotExist(err) ***REMOVED***
...
func (s *DockerSuite) TestCreateLabels(c *check.C) ***REMOVED***
	name := "test_create_labels"
	expected := map[string]string***REMOVED***"k1": "v1", "k2": "v2"***REMOVED***
...
func (s *DockerSuite) TestCreateLabelFromImage(c *check.C) ***REMOVED***
	imageName := "testcreatebuildlabel"
	buildImageSuccessfully(c, imageName, build.WithDockerfile(`FROM busybox
		LABEL k1=v1 k2=v2`))

	name := "test_create_labels_from_image"
	expected := map[string]string***REMOVED***"k2": "x", "k3": "v3", "k1": "v1"***REMOVED***
...
func (s *DockerSuite) TestCreateHostnameWithNumber(c *check.C) ***REMOVED***
	image := "busybox"
...
func (s *DockerSuite) TestCreateRM(c *check.C) ***REMOVED***
...
func (s *DockerSuite) TestCreateModeIpcContainer(c *check.C) ***REMOVED***
...
func (s *DockerSuite) TestCreateByImageID(c *check.C) ***REMOVED***
	...
	***REMOVED***
	...
	if expected := "invalid reference format"; !strings.Contains(out, expected) ***REMOVED***
	...
	***REMOVED***
	...
	if expected := "Unable to find image"; !strings.Contains(out, expected) ***REMOVED***
		c.Fatalf(`Expected %q in output; got: %s`, expected, out)
	***REMOVED***
***REMOVED***

func (s *DockerTrustSuite) TestTrustedCreate(c *check.C) ***REMOVED***
...
func (s *DockerTrustSuite) TestUntrustedCreate(c *check.C) ***REMOVED***
	...
	cli.Docker(cli.Args("create", withTagName), trustedCmd).Assert(c, icmd.Expected***REMOVED***
		ExitCode: 1,
		Err:      fmt.Sprintf("does not have trust data for %s", repoName),
	***REMOVED***)
***REMOVED***

func (s *DockerTrustSuite) TestTrustedIsolatedCreate(c *check.C) ***REMOVED***
...
func (s *DockerTrustSuite) TestTrustedCreateFromBadTrustServer(c *check.C) ***REMOVED***
	...
	cli.Docker(cli.Args("create", repoName), trustedCmd).Assert(c, icmd.Expected***REMOVED***
		ExitCode: 1,
		Err:      "could not rotate trust to a new trusted root",
	***REMOVED***)
***REMOVED***

func (s *DockerSuite) TestCreateStopSignal(c *check.C) ***REMOVED***
...
func (s *DockerSuite) TestCreateWithWorkdir(c *check.C) ***REMOVED***
	name := "foo"
...
func (s *DockerSuite) TestCreateWithInvalidLogOpts(c *check.C) ***REMOVED***
...
// #20972
func (s *DockerSuite) TestCreate64ByteHexID(c *check.C) ***REMOVED***
...
// Test case for #23498
func (s *DockerSuite) TestCreateUnsetEntrypoint(c *check.C) ***REMOVED***
...
// #22471
func (s *DockerSuite) TestCreateStopTimeout(c *check.C) ***REMOVED***
