...
// stop the tests.
func dockerCmdWithFail(c *check.C, args ...string) (string, int) ***REMOVED***
	out, status, err := dockerCmdWithError(args...)
	c.Assert(err, check.NotNil, check.Commentf("%v", out))
	return out, status
***REMOVED***

func (s *DockerSuite) TestNetHostnameWithNetHost(c *check.C) ***REMOVED***
...
func (s *DockerSuite) TestNetHostname(c *check.C) ***REMOVED***
...
func (s *DockerSuite) TestConflictContainerNetworkAndLinks(c *check.C) ***REMOVED***
	testRequires(c, DaemonIsLinux)
...
func (s *DockerSuite) TestConflictContainerNetworkHostAndLinks(c *check.C) ***REMOVED***
	testRequires(c, DaemonIsLinux, NotUserNamespace)
...
func (s *DockerSuite) TestConflictNetworkModeNetHostAndOptions(c *check.C) ***REMOVED***
	testRequires(c, DaemonIsLinux, NotUserNamespace)
...
func (s *DockerSuite) TestConflictNetworkModeAndOptions(c *check.C) ***REMOVED***
	testRequires(c, DaemonIsLinux)
