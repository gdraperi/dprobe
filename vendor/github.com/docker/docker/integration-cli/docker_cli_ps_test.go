...
func (s *DockerSuite) TestPsListContainersBase(c *check.C) ***REMOVED***
	...
	c.Assert(assertContainerList(RemoveOutputForExistingElements(out, existingContainers), []string***REMOVED***fourthID, thirdID, secondID, firstID***REMOVED***), checker.Equals, true, check.Commentf("ALL: Container list is not in the correct order: \n%s", out))

	// running
	out, _ = dockerCmd(c, "ps")
	c.Assert(assertContainerList(RemoveOutputForExistingElements(out, existingContainers), []string***REMOVED***fourthID, secondID, firstID***REMOVED***), checker.Equals, true, check.Commentf("RUNNING: Container list is not in the correct order: \n%s", out))

	// limit
	out, _ = dockerCmd(c, "ps", "-n=2", "-a")
	expected := []string***REMOVED***fourthID, thirdID***REMOVED***
	...
	expected = []string***REMOVED***fourthID, thirdID, secondID***REMOVED***
	...
	expected = []string***REMOVED***fourthID, secondID***REMOVED***
	...
	expected = []string***REMOVED***fourthID***REMOVED***
	c.Assert(assertContainerList(RemoveOutputForExistingElements(out, existingContainers), expected), checker.Equals, true, check.Commentf("SINCE filter: Container list is not in the correct order: \n%s", out))

	// filter before
	out, _ = dockerCmd(c, "ps", "-f", "before="+fourthID, "-a")
	expected = []string***REMOVED***thirdID, secondID, firstID***REMOVED***
	...
	expected = []string***REMOVED***secondID, firstID***REMOVED***
	...
	expected = []string***REMOVED***thirdID, secondID***REMOVED***
	...
	expected = []string***REMOVED***secondID***REMOVED***
	...
	expected = []string***REMOVED***thirdID***REMOVED***
...
func assertContainerList(out string, expected []string) bool ***REMOVED***
	lines := strings.Split(strings.Trim(out, "\n "), "\n")

	if len(lines)-1 != len(expected) ***REMOVED***
		return false
	***REMOVED***
	...
	for i := 0; i < len(expected); i++ ***REMOVED***
		...
		if foundID != expected[i][:12] ***REMOVED***
			return false
		***REMOVED***
	***REMOVED***
...
func (s *DockerSuite) TestPsListContainersInvalidFilterName(c *check.C) ***REMOVED***
	out, _, err := dockerCmdWithError("ps", "-f", "invalidFilter=test")
	c.Assert(err, checker.NotNil)
	c.Assert(out, checker.Contains, "Invalid filter")
***REMOVED***

func (s *DockerSuite) TestPsListContainersSize(c *check.C) ***REMOVED***
...
func (s *DockerSuite) TestPsListContainersFilterStatus(c *check.C) ***REMOVED***
	existingContainers := ExistingContainerIDs(c)
	...
	***REMOVED***)
	...
	if testEnv.OSType != "windows" ***REMOVED***
		...
		defer func() ***REMOVED*** cli.DockerCmd(c, "unpause", pausedID) ***REMOVED***()
...
func (s *DockerSuite) TestPsListContainersFilterHealth(c *check.C) ***REMOVED***
	existingContainers := ExistingContainerIDs(c)
...
func (s *DockerSuite) TestPsListContainersFilterID(c *check.C) ***REMOVED***
	// start container
...
func (s *DockerSuite) TestPsListContainersFilterName(c *check.C) ***REMOVED***
	// start container
...
// - Filter them out :P
func (s *DockerSuite) TestPsListContainersFilterAncestorImage(c *check.C) ***REMOVED***
	existingContainers := ExistingContainerIDs(c)
	...
	var filterTestSuite = []struct ***REMOVED***
		filterName  string
		expectedIDs []string
	***REMOVED******REMOVED***
		// non existent stuff
		***REMOVED***"nonexistent", []string***REMOVED******REMOVED******REMOVED***,
		***REMOVED***"nonexistent:tag", []string***REMOVED******REMOVED******REMOVED***,
		// image
		***REMOVED***"busybox", []string***REMOVED***firstID, secondID, thirdID, fourthID, fifthID***REMOVED******REMOVED***,
		***REMOVED***imageName1, []string***REMOVED***thirdID, fifthID***REMOVED******REMOVED***,
		***REMOVED***imageName2, []string***REMOVED***fifthID***REMOVED******REMOVED***,
		// image:tag
		***REMOVED***fmt.Sprintf("%s:latest", imageName1), []string***REMOVED***thirdID, fifthID***REMOVED******REMOVED***,
		***REMOVED***imageName1Tagged, []string***REMOVED***fourthID***REMOVED******REMOVED***,
		// short-id
		***REMOVED***stringid.TruncateID(imageID1), []string***REMOVED***thirdID, fifthID***REMOVED******REMOVED***,
		***REMOVED***stringid.TruncateID(imageID2), []string***REMOVED***fifthID***REMOVED******REMOVED***,
		// full-id
		***REMOVED***imageID1, []string***REMOVED***thirdID, fifthID***REMOVED******REMOVED***,
		***REMOVED***imageID1Tagged, []string***REMOVED***fourthID***REMOVED******REMOVED***,
		***REMOVED***imageID2, []string***REMOVED***fifthID***REMOVED******REMOVED***,
	***REMOVED***

	var out string
	for _, filter := range filterTestSuite ***REMOVED***
	...
	***REMOVED***
	...
	checkPsAncestorFilterOutput(c, RemoveOutputForExistingElements(out, existingContainers), imageName2+","+imageName1Tagged, []string***REMOVED***fourthID, fifthID***REMOVED***)
***REMOVED***

func checkPsAncestorFilterOutput(c *check.C, out string, filterName string, expectedIDs []string) ***REMOVED***
	actualIDs := []string***REMOVED******REMOVED***
	if out != "" ***REMOVED***
	...
	***REMOVED***
	...
	if len(expectedIDs) > 0 ***REMOVED***
		same := true
		for i := range expectedIDs ***REMOVED***
			if actualIDs[i] != expectedIDs[i] ***REMOVED***
...
func (s *DockerSuite) TestPsListContainersFilterLabel(c *check.C) ***REMOVED***
	// start container
...
func (s *DockerSuite) TestPsListContainersFilterExited(c *check.C) ***REMOVED***
...
func (s *DockerSuite) TestPsRightTagName(c *check.C) ***REMOVED***
...
func (s *DockerSuite) TestPsLinkedWithNoTrunc(c *check.C) ***REMOVED***
	...
	lines = lines[1:]
	lines = RemoveLinesForExistingElements(lines, existingContainers)
	expected := []string***REMOVED***"second", "first,second/first"***REMOVED***
	var names []string
...
func (s *DockerSuite) TestPsGroupPortRange(c *check.C) ***REMOVED***
...
func (s *DockerSuite) TestPsWithSize(c *check.C) ***REMOVED***
	// Problematic on Windows as it doesn't report the size correctly @swernli
	testRequires(c, DaemonIsLinux)
...
func (s *DockerSuite) TestPsListContainersFilterCreated(c *check.C) ***REMOVED***
	// create a container
	...
	for _, line := range strings.Split(out, "\n") ***REMOVED***
		if !strings.Contains(line, shortCID) ***REMOVED***
			continue
		***REMOVED***
		hits++
...
func (s *DockerSuite) TestPsFormatMultiNames(c *check.C) ***REMOVED***
	...
	out, _ := dockerCmd(c, "ps", "--format", "***REMOVED******REMOVED***.Names***REMOVED******REMOVED***", "--no-trunc")
	out = RemoveOutputForExistingElements(out, existingContainers)
	lines := strings.Split(strings.TrimSpace(string(out)), "\n")
	expected := []string***REMOVED***"parent", "child,parent/linkedone"***REMOVED***
	var names []string
	...
	out, _ = dockerCmd(c, "ps", "--format", "***REMOVED******REMOVED***.Names***REMOVED******REMOVED***")
	out = RemoveOutputForExistingElements(out, existingContainers)
	lines = strings.Split(strings.TrimSpace(string(out)), "\n")
	expected = []string***REMOVED***"parent", "child"***REMOVED***
...
func (s *DockerSuite) TestPsNamesMultipleTime(c *check.C) ***REMOVED***
	existingContainers := ExistingContainerNames(c)
	...
	out, _ := dockerCmd(c, "ps", "--format", "***REMOVED******REMOVED***.Names***REMOVED******REMOVED*** ***REMOVED******REMOVED***.Names***REMOVED******REMOVED***")
	lines := strings.Split(strings.TrimSpace(string(out)), "\n")
	lines = RemoveLinesForExistingElements(lines, existingContainers)
	expected := []string***REMOVED***"test2 test2", "test1 test1"***REMOVED***
	var names []string
	names = append(names, lines...)
...
func (s *DockerSuite) TestPsDefaultFormatAndQuiet(c *check.C) ***REMOVED***
	existingContainers := ExistingContainerIDs(c)
	config := `***REMOVED***
		"psFormat": "default ***REMOVED******REMOVED*** .ID ***REMOVED******REMOVED***"
***REMOVED***`
...
func (s *DockerSuite) TestPsImageIDAfterUpdate(c *check.C) ***REMOVED***
	...
	result := icmd.RunCommand(dockerBinary, append([]string***REMOVED***"run", "-d", originalImageName***REMOVED***, sleepCommandForDaemonPlatform()...)...)
	result.Assert(c, icmd.Success)
...
func (s *DockerSuite) TestPsNotShowPortsOfStoppedContainer(c *check.C) ***REMOVED***
	testRequires(c, DaemonIsLinux)
...
func (s *DockerSuite) TestPsShowMounts(c *check.C) ***REMOVED***
	existingContainers := ExistingContainerNames(c)
	...
	***REMOVED***
	...
	out, _ := dockerCmd(c, "ps", "--format", "***REMOVED******REMOVED***.Names***REMOVED******REMOVED*** ***REMOVED******REMOVED***.Mounts***REMOVED******REMOVED***")
	...
	out, _ = dockerCmd(c, "ps", "--format", "***REMOVED******REMOVED***.Names***REMOVED******REMOVED*** ***REMOVED******REMOVED***.Mounts***REMOVED******REMOVED***", "--filter", "volume=ps-volume-test")
	...
	out, _ = dockerCmd(c, "ps", "--format", "***REMOVED******REMOVED***.Names***REMOVED******REMOVED*** ***REMOVED******REMOVED***.Mounts***REMOVED******REMOVED***", "--filter", "volume=this-volume-should-not-exist")
	c.Assert(strings.TrimSpace(string(out)), checker.HasLen, 0)

	// filter by mount destination
	out, _ = dockerCmd(c, "ps", "--format", "***REMOVED******REMOVED***.Names***REMOVED******REMOVED*** ***REMOVED******REMOVED***.Mounts***REMOVED******REMOVED***", "--filter", "volume="+mp)
	...
	out, _ = dockerCmd(c, "ps", "--format", "***REMOVED******REMOVED***.Names***REMOVED******REMOVED*** ***REMOVED******REMOVED***.Mounts***REMOVED******REMOVED***", "--filter", "volume="+bindMountSource)
	...
	out, _ = dockerCmd(c, "ps", "--format", "***REMOVED******REMOVED***.Names***REMOVED******REMOVED*** ***REMOVED******REMOVED***.Mounts***REMOVED******REMOVED***", "--filter", "volume="+bindMountDestination)
	...
	out, _ = dockerCmd(c, "ps", "--format", "***REMOVED******REMOVED***.Names***REMOVED******REMOVED*** ***REMOVED******REMOVED***.Mounts***REMOVED******REMOVED***", "--filter", "volume="+prefix+slash+"this-path-was-never-mounted")
	c.Assert(strings.TrimSpace(string(out)), checker.HasLen, 0)
***REMOVED***

func (s *DockerSuite) TestPsFormatSize(c *check.C) ***REMOVED***
	testRequires(c, DaemonIsLinux)
	runSleepingContainer(c)

	out, _ := dockerCmd(c, "ps", "--format", "table ***REMOVED******REMOVED***.Size***REMOVED******REMOVED***")
	lines := strings.Split(out, "\n")
	c.Assert(lines[1], checker.Not(checker.Equals), "0 B", check.Commentf("Should not display a size of 0 B"))

	out, _ = dockerCmd(c, "ps", "--size", "--format", "table ***REMOVED******REMOVED***.Size***REMOVED******REMOVED***")
	lines = strings.Split(out, "\n")
...
func (s *DockerSuite) TestPsListContainersFilterNetwork(c *check.C) ***REMOVED***
	...
	nwID, _ := dockerCmd(c, "network", "inspect", "--format", "***REMOVED******REMOVED***.ID***REMOVED******REMOVED***", "bridge")
...
func (s *DockerSuite) TestPsByOrder(c *check.C) ***REMOVED***
	name1 := "xyz-abc"
...
func (s *DockerSuite) TestPsFilterMissingArgErrorCode(c *check.C) ***REMOVED***
	_, errCode, _ := dockerCmdWithError("ps", "--filter")
	c.Assert(errCode, checker.Equals, 125)
***REMOVED***

// Test case for 30291
func (s *DockerSuite) TestPsFormatTemplateWithArg(c *check.C) ***REMOVED***
	existingContainers := ExistingContainerNames(c)
	runSleepingContainer(c, "-d", "--name", "top", "--label", "some.label=label.foo-bar")
	out, _ := dockerCmd(c, "ps", "--format", `***REMOVED******REMOVED***.Names***REMOVED******REMOVED*** ***REMOVED******REMOVED***.Label "some.label"***REMOVED******REMOVED***`)
	out = RemoveOutputForExistingElements(out, existingContainers)
	c.Assert(strings.TrimSpace(out), checker.Equals, "top label.foo-bar")
***REMOVED***

func (s *DockerSuite) TestPsListContainersFilterPorts(c *check.C) ***REMOVED***
	testRequires(c, DaemonIsLinux)
	existingContainers := ExistingContainerIDs(c)
...
func (s *DockerSuite) TestPsNotShowLinknamesOfDeletedContainer(c *check.C) ***REMOVED***
	testRequires(c, DaemonIsLinux)
	...
	out, _ := dockerCmd(c, "ps", "--no-trunc", "-a", "--format", "***REMOVED******REMOVED***.Names***REMOVED******REMOVED***")
	lines := strings.Split(strings.TrimSpace(string(out)), "\n")
	lines = RemoveLinesForExistingElements(lines, existingContainers)
	expected := []string***REMOVED***"bbb", "aaa,bbb/aaa"***REMOVED***
	var names []string
	names = append(names, lines...)
	c.Assert(expected, checker.DeepEquals, names, check.Commentf("Expected array with non-truncated names: %v, got: %v", expected, names))
