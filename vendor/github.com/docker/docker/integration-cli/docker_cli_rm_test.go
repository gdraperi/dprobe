...
func (s *DockerSuite) TestRmContainerWithRemovedVolume(c *check.C) ***REMOVED***
...
func (s *DockerSuite) TestRmContainerWithVolume(c *check.C) ***REMOVED***
	prefix, slash := getPrefixAndSlashFromDaemonPlatform()
...
func (s *DockerSuite) TestRmContainerRunning(c *check.C) ***REMOVED***
...
func (s *DockerSuite) TestRmContainerForceRemoveRunning(c *check.C) ***REMOVED***
	createRunningContainer(c, "foo")
...
func (s *DockerSuite) TestRmContainerOrphaning(c *check.C) ***REMOVED***
...
func (s *DockerSuite) TestRmInvalidContainer(c *check.C) ***REMOVED***
...
func createRunningContainer(c *check.C, name string) ***REMOVED***
