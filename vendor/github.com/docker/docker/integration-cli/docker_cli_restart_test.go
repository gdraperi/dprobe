...
func (s *DockerSuite) TestRestartStoppedContainer(c *check.C) ***REMOVED***
	...
	err := waitInspect(cleanedContainerID, "***REMOVED******REMOVED***.State.Running***REMOVED******REMOVED***", "false", 20*time.Second)
...
func (s *DockerSuite) TestRestartRunningContainer(c *check.C) ***REMOVED***
	...
	getLogs := func(c *check.C) (interface***REMOVED******REMOVED***, check.CommentInterface) ***REMOVED***
		out, _ := dockerCmd(c, "logs", cleanedContainerID)
		return out, nil
	***REMOVED***
...
func (s *DockerSuite) TestRestartWithVolumes(c *check.C) ***REMOVED***
...
func (s *DockerSuite) TestRestartDisconnectedContainer(c *check.C) ***REMOVED***
...
func (s *DockerSuite) TestRestartPolicyNO(c *check.C) ***REMOVED***
...
func (s *DockerSuite) TestRestartPolicyAlways(c *check.C) ***REMOVED***
...
func (s *DockerSuite) TestRestartPolicyOnFailure(c *check.C) ***REMOVED***
...
func (s *DockerSuite) TestRestartContainerwithGoodContainer(c *check.C) ***REMOVED***
	out, _ := dockerCmd(c, "run", "-d", "--restart=on-failure:3", "busybox", "true")

	id := strings.TrimSpace(string(out))
	err := waitInspect(id, "***REMOVED******REMOVED*** .State.Restarting ***REMOVED******REMOVED*** ***REMOVED******REMOVED*** .State.Running ***REMOVED******REMOVED***", "false false", 30*time.Second)
	c.Assert(err, checker.IsNil)
...
func (s *DockerSuite) TestRestartContainerSuccess(c *check.C) ***REMOVED***
	...
	err = waitInspect(id, "***REMOVED******REMOVED***.RestartCount***REMOVED******REMOVED***", "1", 30*time.Second)
	c.Assert(err, check.IsNil)

	err = waitInspect(id, "***REMOVED******REMOVED***.State.Status***REMOVED******REMOVED***", "running", 30*time.Second)
	c.Assert(err, check.IsNil)
***REMOVED***

func (s *DockerSuite) TestRestartWithPolicyUserDefinedNetwork(c *check.C) ***REMOVED***
	...
	err = waitInspect("second", "***REMOVED******REMOVED***.RestartCount***REMOVED******REMOVED***", "1", 5*time.Second)
	c.Assert(err, check.IsNil)

	err = waitInspect("second", "***REMOVED******REMOVED***.State.Status***REMOVED******REMOVED***", "running", 5*time.Second)
...
func (s *DockerSuite) TestRestartPolicyAfterRestart(c *check.C) ***REMOVED***
	testRequires(c, SameHostDaemon)
...
func (s *DockerSuite) TestRestartContainerwithRestartPolicy(c *check.C) ***REMOVED***
	...
	***REMOVED***
	err := waitInspect(id1, "***REMOVED******REMOVED*** .State.Restarting ***REMOVED******REMOVED*** ***REMOVED******REMOVED*** .State.Running ***REMOVED******REMOVED***", "false false", waitTimeout)
	c.Assert(err, checker.IsNil)
	...
	err = waitInspect(id1, "***REMOVED******REMOVED*** .State.Restarting ***REMOVED******REMOVED*** ***REMOVED******REMOVED*** .State.Running ***REMOVED******REMOVED***", "false false", waitTimeout)
	c.Assert(err, checker.IsNil)
	err = waitInspect(id2, "***REMOVED******REMOVED*** .State.Restarting ***REMOVED******REMOVED*** ***REMOVED******REMOVED*** .State.Running ***REMOVED******REMOVED***", "false false", waitTimeout)
	c.Assert(err, checker.IsNil)
***REMOVED***

func (s *DockerSuite) TestRestartAutoRemoveContainer(c *check.C) ***REMOVED***
	out := runSleepingContainer(c, "--rm")

	id := strings.TrimSpace(string(out))
	dockerCmd(c, "restart", id)
	err := waitInspect(id, "***REMOVED******REMOVED*** .State.Restarting ***REMOVED******REMOVED*** ***REMOVED******REMOVED*** .State.Running ***REMOVED******REMOVED***", "false true", 15*time.Second)
	c.Assert(err, checker.IsNil)
