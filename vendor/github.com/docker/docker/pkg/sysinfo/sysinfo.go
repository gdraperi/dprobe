...
type cgroupMemInfo struct ***REMOVED***
...
type cgroupCPUInfo struct ***REMOVED***
...
type cgroupBlkioInfo struct ***REMOVED***
...
type cgroupCpusetInfo struct ***REMOVED***
...
type cgroupPids struct ***REMOVED***
...
func (c cgroupCpusetInfo) IsCpusetCpusAvailable(provided string) (bool, error) ***REMOVED***
...
// If error is not nil a parsing error occurred.
func (c cgroupCpusetInfo) IsCpusetMemsAvailable(provided string) (bool, error) ***REMOVED***
	return isCpusetListAvailable(provided, c.Mems)
***REMOVED***

func isCpusetListAvailable(provided, available string) (bool, error) ***REMOVED***
	...
	***REMOVED***
	...
	if err != nil ***REMOVED***
		return false, err
	***REMOVED***
	for k := range parsedProvided ***REMOVED***
		if !parsedAvailable[k] ***REMOVED***
			return false, nil
		***REMOVED***
	***REMOVED***
	return true, nil
...
func popcnt(x uint64) (n byte) ***REMOVED***
