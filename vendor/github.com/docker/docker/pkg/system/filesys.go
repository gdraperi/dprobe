...
func MkdirAll(path string, perm os.FileMode, sddl string) error ***REMOVED***
...
// If there is an error, it will be of type *PathError.
func OpenFileSequential(name string, flag int, perm os.FileMode) (*os.File, error) ***REMOVED***
