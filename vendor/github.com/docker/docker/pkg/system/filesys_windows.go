...
func MkdirAllWithACL(path string, perm os.FileMode, sddl string) error ***REMOVED***
	return mkdirall(path, true, sddl)
***REMOVED***

// MkdirAll implementation that is volume path aware for Windows.
func MkdirAll(path string, _ os.FileMode, sddl string) error ***REMOVED***
...
// a DACL.
func mkdirall(path string, applyACL bool, sddl string) error ***REMOVED***
...
// and Local System.
func mkdirWithACL(name string, sddl string) error ***REMOVED***
	sa := windows.SecurityAttributes***REMOVED***Length: 0***REMOVED***
...
func windowsOpenFileSequential(name string, flag int, _ os.FileMode) (file *os.File, err error) ***REMOVED***
...
func makeInheritSa() *windows.SecurityAttributes ***REMOVED***
...
func windowsOpenSequential(path string, mode int, _ uint32) (fd windows.Handle, err error) ***REMOVED***
	...
	***REMOVED***
	var access uint32
	switch mode & (windows.O_RDONLY | windows.O_WRONLY | windows.O_RDWR) ***REMOVED***
	...
	***REMOVED***
	if mode&windows.O_CREAT != 0 ***REMOVED***
		access |= windows.GENERIC_WRITE
	***REMOVED***
	if mode&windows.O_APPEND != 0 ***REMOVED***
		access &^= windows.GENERIC_WRITE
		access |= windows.FILE_APPEND_DATA
	***REMOVED***
	sharemode := uint32(windows.FILE_SHARE_READ | windows.FILE_SHARE_WRITE)
	var sa *windows.SecurityAttributes
	if mode&windows.O_CLOEXEC == 0 ***REMOVED***
		sa = makeInheritSa()
	***REMOVED***
...
func TempFileSequential(dir, prefix string) (f *os.File, err error) ***REMOVED***
	if dir == "" ***REMOVED***
		dir = os.TempDir()
	***REMOVED***
