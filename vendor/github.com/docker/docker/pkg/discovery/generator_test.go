...
func (s *DiscoverySuite) TestGeneratorNotGenerate(c *check.C) ***REMOVED***
	ips := Generate("127.0.0.1")
	c.Assert(len(ips), check.Equals, 1)
	c.Assert(ips[0], check.Equals, "127.0.0.1")
***REMOVED***

func (s *DiscoverySuite) TestGeneratorWithPortNotGenerate(c *check.C) ***REMOVED***
	ips := Generate("127.0.0.1:8080")
	c.Assert(len(ips), check.Equals, 1)
	c.Assert(ips[0], check.Equals, "127.0.0.1:8080")
***REMOVED***

func (s *DiscoverySuite) TestGeneratorMatchFailedNotGenerate(c *check.C) ***REMOVED***
	ips := Generate("127.0.0.[1]")
	c.Assert(len(ips), check.Equals, 1)
	c.Assert(ips[0], check.Equals, "127.0.0.[1]")
***REMOVED***

func (s *DiscoverySuite) TestGeneratorWithPort(c *check.C) ***REMOVED***
...
func (s *DiscoverySuite) TestGenerateWithMalformedInputAtRangeStart(c *check.C) ***REMOVED***
...
func (s *DiscoverySuite) TestGenerateWithMalformedInputAtRangeEnd(c *check.C) ***REMOVED***
